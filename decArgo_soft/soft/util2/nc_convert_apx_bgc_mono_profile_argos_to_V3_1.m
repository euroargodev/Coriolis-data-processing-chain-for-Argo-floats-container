...
for idParam = 1:length(paramlist)
   ...
   if (strcmp(paramName, 'PRES'))
      ...
      paramStruct = get_netcdf_param_attributes(paramNameBis);
...
if (ismember('CHLT', paramlist))
   ...
   chlaParam = get_netcdf_param_attributes('CHLA');
...
if (ismember('TURBIDITY', paramlist))
   ...
   turbidityParam = get_netcdf_param_attributes('TURBIDITY');
...
for idParam = 1:length(paramlist)
   ...
   paramInfo = get_netcdf_param_attributes(paramNameOriBis);
...
nParamDimBOutput = 1;
for idParam = 1:length(paramlist)
   paramStruct = get_netcdf_param_attributes(paramlist{idParam});
   if ((paramStruct.paramType == 'c') || (paramStruct.paramType == 'j'))
