...
if (CORIOLIS_CONFIGURATION_FLAG)
   ...
   % list of sensors mounted on floats
   % SENSOR_LIST_FILE_NAME = 'C:\Users\jprannou\Desktop\SOS_VB_new\float_sensor_list.txt';
   SENSOR_LIST_FILE_NAME = 'C:\Users\jprannou\_RNU\DecArgo_info\_float_sensor_list\float_sensor_list.txt';

   % meta-data file exported from Coriolis data base
   % FLOAT_META_FILE_NAME = 'C:\Users\jprannou\Desktop\SOS_VB_new\new_rem_meta.txt';
   % FLOAT_META_FILE_NAME = 'C:\Users\jprannou\_RNU\DecPrv_info\_configParamNames\DB_Export\7902195_7.20_dbexport.txt';
   % FLOAT_META_FILE_NAME = 'C:\Users\jprannou\_RNU\DecPrv_info\_configParamNames\DB_Export\CTS5_nitrate_bisulfide.txt';
   % FLOAT_META_FILE_NAME = 'C:\Users\jprannou\_RNU\DecPrv_info\_configParamNames\DB_Export\CTS5_138.txt';
   % FLOAT_META_FILE_NAME = 'C:\Users\jprannou\_RNU\DecPrv_info\_configParamNames\DB_Export\db_export_cts5_7.24_4903881.txt';
   ...
   FLOAT_META_FILE_NAME = 'C:\Users\jprannou\_RNU\DecPrv_info\_configParamNames\DB_Export\dbExport_CTS5_BODC_2901931_2901932_ECO_FLNTU.txt';
...
for idFloat = 1:nbFloats
   ...
   for idSensor = 1:length(sensorList)
      [paramName, paramDimLevel, paramSensor, paramUnits, paramAccuracy, paramResolution] = ...
         get_sensor_parameter_info(sensorList{idSensor}, floatNum, floatDecId, metaWmoList, metaData, sensorList);
...
switch a_inputSensorName
   ...
   case 'OCR'
      switch a_decId
         ...
         case {133, 138, 139, 140}
            ...
            o_sensorModel = [{'SATLANTIC_OCR504_ICSW'} {'SATLANTIC_OCR504_ICSW'} {'SATLANTIC_OCR504_ICSW'} {'SATLANTIC_OCR504_ICSW'}];
         case {134}
            o_sensorName = [{'RADIOMETER_DOWN_IRR443'} {'RADIOMETER_DOWN_IRR490'} {'RADIOMETER_DOWN_IRR555'} {'RADIOMETER_PAR'}];
            o_sensorDimLevel = [205 203 207 204];
            o_sensorMaker = [{'SATLANTIC'} {'SATLANTIC'} {'SATLANTIC'} {'SATLANTIC'}];
            o_sensorModel = [{'SATLANTIC_OCR504_ICSW'} {'SATLANTIC_OCR504_ICSW'} {'SATLANTIC_OCR504_ICSW'} {'SATLANTIC_OCR504_ICSW'}];
         otherwise
   ...
   case 'TRIDENTE'
      o_sensorName = [{'AUX_FLUOROMETER_CHLA'} {'AUX_BACKSCATTERINGMETER_BBP700'} {'AUX_FLUOROMETER_CDOM'}];
      o_sensorDimLevel = [1701 1702 1703];
      o_sensorMaker = [{'RBR'} {'RBR'} {'RBR'}];
      o_sensorModel = [{'RBR_TRIDENTE_FLBBCD'} {'RBR_TRIDENTE_FLBBCD'} {'RBR_TRIDENTE_FLBBCD'}];

   case 'TRIDENTE2'
      o_sensorName = [{'AUX_FLUOROMETER_CHLA_2'} {'AUX_BACKSCATTERINGMETER_BBP700_2'} {'AUX_BACKSCATTERINGMETER_BBP700_3'}];
      o_sensorDimLevel = [1704 1705 1706];
      o_sensorMaker = [{'RBR'} {'RBR'} {'RBR'}];
      o_sensorModel = [{'RBR_TRIDENTE_FLBB2'} {'RBR_TRIDENTE_FLBB2'} {'RBR_TRIDENTE_FLBB2'}];

   case 'PAL'
      o_sensorName = {'AUX_HYDROPHONE'};
      o_sensorDimLevel = [1801];
      o_sensorMaker = {'High Tech Inc'};
      o_sensorModel = {'HTI_96_MIN'};
...
function [o_paramName, o_paramDimLevel, o_paramSensor, ...
   ...
   a_metaWmoList, a_metaData, a_sensorList)
...
switch a_inputSensorName
   ...
   case 'OCR'
      switch a_decId
         ...
         case {134}
            o_paramName = [ ...
               {'RAW_DOWNWELLING_IRRADIANCE443'} {'RAW_DOWNWELLING_IRRADIANCE490'} ...
               {'RAW_DOWNWELLING_IRRADIANCE555'} {'RAW_DOWNWELLING_PAR'} ...
               {'DOWN_IRRADIANCE443'} {'DOWN_IRRADIANCE490'} ...
               {'DOWN_IRRADIANCE555'} {'DOWNWELLING_PAR'} ...
               ];
            o_paramDimLevel = [209 203 213 204 211 207 214 208];
            o_paramSensor = [ ...
               {'RADIOMETER_DOWN_IRR443'} {'RADIOMETER_DOWN_IRR490'} ...
               {'RADIOMETER_DOWN_IRR555'} {'RADIOMETER_PAR'} ...
               {'RADIOMETER_DOWN_IRR443'} {'RADIOMETER_DOWN_IRR490'} ...
               {'RADIOMETER_DOWN_IRR555'} {'RADIOMETER_PAR'} ...
               ];
            o_paramUnits = [ ...
   ...
   case 'ECO_FLNTU'
      ...
      o_paramDimLevel = [301 312 305 311 313];
      o_paramSensor = [ ...
   ...
   case 'SUNA'
      switch a_decId
         case {126, 128, 129, 130, 132, 133, 135, 138, 139, 140}
            o_paramName = [ ...
               {'TEMP_NITRATE'} ...
   ...
   case 'OPUS'
      if (~any(strcmp(a_sensorList, 'SUNA')))
         o_paramName = [ ...
         ...
         o_paramName = [ ...
            ...
            {'AVERAGING_NITRATE'} ...
            {'FLASH_COUNT_NITRATE'} ...
            {'TEMP_SPECTROPHOTOMETER_NITRATE_2'} ...
            {'UV_INTENSITY_NITRATE_2'} ...
            {'UV_INTENSITY_DARK_NITRATE_AVG'} ...
            {'UV_INTENSITY_DARK_NITRATE_SD'} ...
            ];
      end
      o_paramDimLevel = 901:907;
      o_paramSensor = [ ...
   ...
   case 'TRIDENTE'
      ...
      o_paramDimLevel = [1701 1702 1703 1704];
      o_paramSensor = [ ...
         {'AUX_BACKSCATTERINGMETER_BBP700'} ...
         {'AUX_FLUOROMETER_CHLA'} {'AUX_BACKSCATTERINGMETER_BBP700'} {'AUX_FLUOROMETER_CDOM'} ...
         ];
      o_paramUnits = [ ...
         {'m-1sr-1'} ...
         {'mg/m3'} {'m-1'} {'ppb'} ...
   ...
   case 'TRIDENTE2'
      o_paramName = [ ...
         {'BETA_BACKSCATTERING700_SCALED'} {'BETA_BACKSCATTERING700_SCALED_2'} ...
         {'CHLA_2'} {'BBP700_2'} {'BBP700_3'} ...
         ];
      o_paramDimLevel = [1701 1705 1703 1706 1707];
      o_paramSensor = [ ...
         {'AUX_BACKSCATTERINGMETER_BBP700_2'} {'AUX_BACKSCATTERINGMETER_BBP700_3'} ...
