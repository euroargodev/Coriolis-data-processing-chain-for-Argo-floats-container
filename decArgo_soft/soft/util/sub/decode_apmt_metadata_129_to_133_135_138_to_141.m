...
%
% SYNTAX :
%  [o_metaData] = decode_apmt_metadata_129_to_133_135_138_to_141(a_inputFilePathName)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function [o_metaData] = decode_apmt_metadata_129_to_133_135_138_to_141(a_inputFilePathName)
...
if ~(exist(a_inputFilePathName, 'file') == 2)
   fprintf('ERROR: decode_apmt_metadata_129_to_133_135_138_to_141: File not found: %s\n', a_inputFilePathName);
   return
end
...
sensors.sensor_opus.spectrum.length = '';
sensors.sensor_opus.spectrum.wavelengths = '';
sensors.sensor_opus.sensor_lamp.sn = '';
sensors.sensor_opus.spectrometer.path = '';
...
sensors.sensor_pal = [];
sensors.sensor_pal.sensor.sn = '';
sensors.sensor_pal.sensor.model = '';
sensors.sensor_pal.pal_board.firmware = '';
sensors.sensor_pal.acoustic.filter = '';
sensors.sensor_pal.acoustic.gain = '';
sensors.sensor_pal.hydrophone.sn = '';
sensors.sensor_pal.hydrophone.model = '';
sensors.sensor_pal.hydrophone.sensitivity = '';
sensors.sensor_pal.spectrum.length = '';
sensors.sensor_pal.spectrum.bands = '';
sensors.sensor_pal.spectrum.normalization = '';
sensors.sensor_pal.quantify_wind.a3 = '';
sensors.sensor_pal.quantify_wind.a2 = '';
sensors.sensor_pal.quantify_wind.a1 = '';
sensors.sensor_pal.quantify_wind.a0 = '';
sensors.sensor_pal.quantify_rain.b3 = '';
sensors.sensor_pal.quantify_rain.b2 = '';
sensors.sensor_pal.quantify_rain.b1 = '';
sensors.sensor_pal.quantify_rain.b0 = '';
sensors.sensor_pal.classify_noise.c0 = '';

sensors.sensor_tridente = [];
sensors.sensor_tridente.sensor.sn = '';
sensors.sensor_tridente.sensor.mode = '';
sensors.sensor_tridente.sensor.average = '';
sensors.sensor_tridente.sensor.outputs = '';
