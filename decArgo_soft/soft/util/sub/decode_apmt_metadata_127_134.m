...
%
% SYNTAX :
%  [o_metaData] = decode_apmt_metadata_127_134(a_inputFilePathName)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function [o_metaData] = decode_apmt_metadata_127_134(a_inputFilePathName)
...
if ~(exist(a_inputFilePathName, 'file') == 2)
   fprintf('ERROR: decode_apmt_metadata_127_134: File not found: %s\n', a_inputFilePathName);
   return
end
