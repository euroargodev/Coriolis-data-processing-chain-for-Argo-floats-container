...
% ------------------------------------------------------------------------------
function [o_metaStruct] = get_meta_data_cts5_134(...
   a_metaDataXmlFileName, a_metaStruct, a_sensorListNum, a_floatNum, a_outputCsvDirName, a_rtVersionFlag)
...
% read meta-data file
metaData = decode_apmt_metadata_127_134(a_metaDataXmlFileName);
   ...
   if (any(a_sensorListNum == 3))
      if (~a_rtVersionFlag)
         if (isfield(metaData.sensors, 'sensor_ocr'))
            idF = find(strcmp('RADIOMETER_DOWN_IRR443', o_metaStruct.SENSOR));
            idF2 = find(strcmp('RADIOMETER_DOWN_IRR490', o_metaStruct.SENSOR));
            idF3 = find(strcmp('RADIOMETER_DOWN_IRR555', o_metaStruct.SENSOR));
            ...
            if (~isempty(idF) && ~isempty(idF2) && ~isempty(idF3) && ~isempty(idF4))
                  ...
                  if (isfield(metaData.sensors.sensor_ocr.channel_01, 'a0'))
                     if (~isfield(o_metaStruct.CALIBRATION_COEFFICIENT, 'OCR'))
                        ...
                        fprintf(g_cogj_csvFileCoefId, '%d;OCR;A0Lambda443;%s\n', ...
                           a_floatNum, ...
                           metaData.sensors.sensor_ocr.channel_01.a0);
                     elseif (str2double(metaData.sensors.sensor_ocr.channel_01.a0) ~= str2double(o_metaStruct.CALIBRATION_COEFFICIENT.OCR.A0Lambda443))
                        if (isempty(g_cogj_csvFileCoefId) || (g_cogj_csvFileCoefId == -1))
                           [g_cogj_csvFileCoefId, g_cogj_csvFileCoefPathName] = open_csv_file(a_outputCsvDirName, 'C', g_cogj_csvFileCoefPathName);
                        end
                  ...
                  if (isfield(metaData.sensors.sensor_ocr.channel_01, 'a1'))
                     if (~isfield(o_metaStruct.CALIBRATION_COEFFICIENT, 'OCR'))
                        ...
                        fprintf(g_cogj_csvFileCoefId, '%d;OCR;A1Lambda443;%s\n', ...
                           a_floatNum, ...
                           metaData.sensors.sensor_ocr.channel_01.a1);
                     elseif (str2double(metaData.sensors.sensor_ocr.channel_01.a1) ~= str2double(o_metaStruct.CALIBRATION_COEFFICIENT.OCR.A1Lambda443))
                        if (isempty(g_cogj_csvFileCoefId) || (g_cogj_csvFileCoefId == -1))
                           [g_cogj_csvFileCoefId, g_cogj_csvFileCoefPathName] = open_csv_file(a_outputCsvDirName, 'C', g_cogj_csvFileCoefPathName);
                        end
                  ...
                  if (isfield(metaData.sensors.sensor_ocr.channel_01, 'im'))
                     if (~isfield(o_metaStruct.CALIBRATION_COEFFICIENT, 'OCR'))
                        ...
                        fprintf(g_cogj_csvFileCoefId, '%d;OCR;LmLambda443;%s\n', ...
                           a_floatNum, ...
                           metaData.sensors.sensor_ocr.channel_01.im);
                     elseif (str2double(metaData.sensors.sensor_ocr.channel_01.im) ~= str2double(o_metaStruct.CALIBRATION_COEFFICIENT.OCR.LmLambda443))
                        if (isempty(g_cogj_csvFileCoefId) || (g_cogj_csvFileCoefId == -1))
                           [g_cogj_csvFileCoefId, g_cogj_csvFileCoefPathName] = open_csv_file(a_outputCsvDirName, 'C', g_cogj_csvFileCoefPathName);
                        end
                  ...
                  if (isfield(metaData.sensors.sensor_ocr.channel_02, 'a0'))
                     if (~isfield(o_metaStruct.CALIBRATION_COEFFICIENT, 'OCR'))
                        ...
                        fprintf(g_cogj_csvFileCoefId, '%d;OCR;A0Lambda490;%s\n', ...
                           a_floatNum, ...
                           metaData.sensors.sensor_ocr.channel_02.a0);
                     elseif (str2double(metaData.sensors.sensor_ocr.channel_02.a0) ~= str2double(o_metaStruct.CALIBRATION_COEFFICIENT.OCR.A0Lambda490))
                        if (isempty(g_cogj_csvFileCoefId) || (g_cogj_csvFileCoefId == -1))
                           [g_cogj_csvFileCoefId, g_cogj_csvFileCoefPathName] = open_csv_file(a_outputCsvDirName, 'C', g_cogj_csvFileCoefPathName);
                        end
                  ...
                  if (isfield(metaData.sensors.sensor_ocr.channel_02, 'a1'))
                     if (~isfield(o_metaStruct.CALIBRATION_COEFFICIENT, 'OCR'))
                        ...
                        fprintf(g_cogj_csvFileCoefId, '%d;OCR;A1Lambda490;%s\n', ...
                           a_floatNum, ...
                           metaData.sensors.sensor_ocr.channel_02.a1);
                     elseif (str2double(metaData.sensors.sensor_ocr.channel_02.a1) ~= str2double(o_metaStruct.CALIBRATION_COEFFICIENT.OCR.A1Lambda490))
                        if (isempty(g_cogj_csvFileCoefId) || (g_cogj_csvFileCoefId == -1))
                           [g_cogj_csvFileCoefId, g_cogj_csvFileCoefPathName] = open_csv_file(a_outputCsvDirName, 'C', g_cogj_csvFileCoefPathName);
                        end
                  ...
                  if (isfield(metaData.sensors.sensor_ocr.channel_02, 'im'))
                     if (~isfield(o_metaStruct.CALIBRATION_COEFFICIENT, 'OCR'))
                        ...
                        fprintf(g_cogj_csvFileCoefId, '%d;OCR;LmLambda490;%s\n', ...
                           a_floatNum, ...
                           metaData.sensors.sensor_ocr.channel_02.im);
                     elseif (str2double(metaData.sensors.sensor_ocr.channel_02.im) ~= str2double(o_metaStruct.CALIBRATION_COEFFICIENT.OCR.LmLambda490))
                        if (isempty(g_cogj_csvFileCoefId) || (g_cogj_csvFileCoefId == -1))
                           [g_cogj_csvFileCoefId, g_cogj_csvFileCoefPathName] = open_csv_file(a_outputCsvDirName, 'C', g_cogj_csvFileCoefPathName);
                        end
                  ...
                  if (isfield(metaData.sensors.sensor_ocr.channel_03, 'a0'))
                     if (~isfield(o_metaStruct.CALIBRATION_COEFFICIENT, 'OCR'))
                        ...
                        fprintf(g_cogj_csvFileCoefId, '%d;OCR;A0Lambda555;%s\n', ...
                           a_floatNum, ...
                           metaData.sensors.sensor_ocr.channel_03.a0);
                     elseif (str2double(metaData.sensors.sensor_ocr.channel_03.a0) ~= str2double(o_metaStruct.CALIBRATION_COEFFICIENT.OCR.A0Lambda555))
                        if (isempty(g_cogj_csvFileCoefId) || (g_cogj_csvFileCoefId == -1))
                           [g_cogj_csvFileCoefId, g_cogj_csvFileCoefPathName] = open_csv_file(a_outputCsvDirName, 'C', g_cogj_csvFileCoefPathName);
                        end
                  ...
                  if (isfield(metaData.sensors.sensor_ocr.channel_03, 'a1'))
                     if (~isfield(o_metaStruct.CALIBRATION_COEFFICIENT, 'OCR'))
                        ...
                        fprintf(g_cogj_csvFileCoefId, '%d;OCR;A1Lambda555;%s\n', ...
                           a_floatNum, ...
                           metaData.sensors.sensor_ocr.channel_03.a1);
                     elseif (str2double(metaData.sensors.sensor_ocr.channel_03.a1) ~= str2double(o_metaStruct.CALIBRATION_COEFFICIENT.OCR.A1Lambda555))
                        if (isempty(g_cogj_csvFileCoefId) || (g_cogj_csvFileCoefId == -1))
                           [g_cogj_csvFileCoefId, g_cogj_csvFileCoefPathName] = open_csv_file(a_outputCsvDirName, 'C', g_cogj_csvFileCoefPathName);
                        end
                  ...
                  if (isfield(metaData.sensors.sensor_ocr.channel_03, 'im'))
                     if (~isfield(o_metaStruct.CALIBRATION_COEFFICIENT, 'OCR'))
                        ...
                        fprintf(g_cogj_csvFileCoefId, '%d;OCR;LmLambda555;%s\n', ...
                           a_floatNum, ...
                           metaData.sensors.sensor_ocr.channel_03.im);
                     elseif (str2double(metaData.sensors.sensor_ocr.channel_03.im) ~= str2double(o_metaStruct.CALIBRATION_COEFFICIENT.OCR.LmLambda555))
                        if (isempty(g_cogj_csvFileCoefId) || (g_cogj_csvFileCoefId == -1))
                           [g_cogj_csvFileCoefId, g_cogj_csvFileCoefPathName] = open_csv_file(a_outputCsvDirName, 'C', g_cogj_csvFileCoefPathName);
                        end
               ...
               fprintf('ERROR: Float #%d: cannot find expected ''RADIOMETER_DOWN_IRR443'' and/or ''RADIOMETER_DOWN_IRR490'' and/or ''RADIOMETER_DOWN_IRR555'' and/or ''RADIOMETER_PAR'' sensor in DB contents - OCR metadata ignored\n', ...
                  a_floatNum);
            end
         end
      end
