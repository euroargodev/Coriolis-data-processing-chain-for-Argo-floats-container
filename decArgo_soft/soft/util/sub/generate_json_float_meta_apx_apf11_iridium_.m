...
%   a_calibFileName, a_configDirName, a_ramsesConfigDirName, ...
%   a_outputDirName, a_csvDirName, a_rudicsFlag, a_rtVersionFlag)
%
% INPUT PARAMETERS :
...
for idFloat = 1:length(floatList)
   ...
   switch (dacFormatId)
      case {'2.11.1.S', '2.12.2.1.S', '2.11.3.R', '2.12.2.1.R', '2.12.3.R', ...
            '2.13.1.R', '2.13.1.1.R', '2.14.3.R', '2.15.0.R', '2.15.2.R', ...
            '2.15.5.R', '2.16.0.R', '2.16.1.R', '2.17.4.R', '2.18.1.R', '2.19.1.R'}
      ...
      for idC = 1:length(confNames)
         ...
         if (strcmp(floatConfName, 'iridium')) % see 6903699 & 6903700
            if (ismember(dacFormatId, [{'2.10.1.S'} {'2.11.1.S'} {'2.12.2.1.S'} {'2.10.4.R'} {'2.11.3.R'} {'2.12.2.1.R'} {'2.12.3.R'}]))
               continue
            elseif (ismember(dacFormatId, [{'2.13.1.R'} {'2.13.1.1.R'} ...
                  {'2.14.3.R'} {'2.15.0.R'} {'2.15.2.R'} {'2.15.5.R'} ...
                  {'2.16.0.R'} {'2.16.1.R'} {'2.17.4.R'} {'2.18.1.R'} {'2.19.1.R'}]))
         ...
         if (~isempty(bddConfName))
            ...
            nbLoops = 1;
            if (ismember(dacFormatId, [{'2.10.1.S'} {'2.11.1.S'} {'2.12.2.1.S'} ...
                  {'2.10.4.R'} {'2.12.2.1.R'} {'2.12.3.R'} {'2.11.3.R'}]))
               if (strcmp(floatConfName, 'float_id'))
                  nbLoops = 2;
               end
            end
            if (ismember(dacFormatId, [{'2.13.1.R'} {'2.13.1.1.R'} {'2.14.3.R'} ...
                  {'2.15.0.R'} {'2.15.2.R'} {'2.15.5.R'} {'2.16.0.R'} {'2.16.1.R'}...
                  {'2.17.4.R'} {'2.18.1.R'} {'2.19.1.R'}]))
               if (strcmp(floatConfName, 'TelemetryDays'))
                  nbLoops = 2;
            ...
            for idL = 1:nbLoops
               ...
               if (diffFlag ~= -1)
                  ...
                  if (diffFlag == 0)
                     ...
                     if (ismember(bddConfName, [{'CONTROLLER_BOARD_SERIAL_NO_PRIMA'}, {'FLOAT_RUDICS_ID'}]))
                        if (a_rtVersionFlag == 0)
                           fprintf('ERROR: Float #%d: DIFFER: Meta-data ''%s'': launch float value (''%s'') and data base value (''%s'') differ - DB contents should be updated (see %s)\n', ...
                              floatNum, ...
                              bddConfName, ...
                              floatConfValue, ...
                              bddConfvalue, ...
                           ...
                           fprintf('ERROR: Float #%d: DIFFER: Meta-data ''%s'': launch float value (''%s'') and data base value (''%s'') differ - DB contents should be updated\n', ...
                              floatNum, ...
                              bddConfName, ...
                              floatConfValue, ...
                              bddConfvalue);
   ...
   dbConfigParamNameCode = [ ...
      ...
      {'CROVER_IN_PUMPED_STREAM'}        {'CONFIG_PX_1_5_0_0_1'}; ...
      {'CROVER_BEAM_ATT_WAVELENGTH'}     {'CONFIG_PX_1_5_0_0_6'}; ...
      ...
      {'SEAFET_VERTICAL_PRES_OFFSET'}    {'CONFIG_PX_1_4_0_0_0'}; ...
...
switch (a_dacFormatId)
   ...
   case {'2.15.0.R', '2.15.2.R', '2.15.5.R', '2.16.0.R', '2.16.1.R', '2.17.4.R', '2.18.1.R', '2.19.1.R'}
      o_configStruct = struct( ...
         'CONFIG_DIR_ProfilingDirection', 'DIRECTION', ...
         'CONFIG_CT_CycleTime', 'CYCLE_TIME', ...
         'CONFIG_ARM_ActivateRecoveryModeFlag', 'ActivateRecoveryModeFlag', ...
...
switch (a_dacFormatId)
   ...
   case {'2.15.0.R', '2.15.2.R', '2.15.5.R', '2.16.0.R', '2.16.1.R', '2.17.4.R', ...
         '2.18.1.R', '2.19.1.R'}
      o_configStruct = struct( ...
         'ActivateRecoveryMode', 'CONFIG_ARM_ActivateRecoveryModeFlag', ...
         'AscentRate', 'CONFIG_AR_AscentRate', ...
