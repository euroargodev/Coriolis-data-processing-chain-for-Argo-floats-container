...
if (isempty(idDataStdMed))
   ...
   dataMean(:, 6) = compute_CHLA_1xx_and_1121_to_1132_1322_1323(dataMean(:, 4), g_decArgo_chloroADef, paramCHLA.fillValue);
   ...
   if (isempty(idDataMean))
      ...
      paramCHLA = get_netcdf_param_attributes('CHLA');
      data(:, 10) = compute_CHLA_1xx_and_1121_to_1132_1322_1323(data(:, 4), g_decArgo_chloroADef, paramCHLA.fillValue);
