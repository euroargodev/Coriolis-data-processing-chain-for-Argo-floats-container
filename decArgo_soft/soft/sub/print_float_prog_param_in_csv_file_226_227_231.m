...
%
% SYNTAX :
%  print_float_prog_param_in_csv_file_226_227_231(a_floatParam1, a_floatParam2, a_decoderId)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function print_float_prog_param_in_csv_file_226_227_231(a_floatParam1, a_floatParam2, a_decoderId)
...
elseif (size(a_floatParam1, 1) == 1)
   ...
   elseif (a_decoderId == 227)
      fprintf(g_decArgo_outputCsvFileId, '%d; %d; Prog1_%d; TC27: CTD data type transmission code (0: P/T/PSAL, 1: P/T/PSAL/TEMP_CNDC, 3: P/T/PSAL/PSAL_DynamicCorrection, 7: P/T/PSAL_DynamicCorrection); %d\n', ...
         g_decArgo_floatNum, g_decArgo_cycleNum, a_floatParam1(id, 2+ID_OFFSET), a_floatParam1(id, 72+ID_OFFSET));
   end
