...
%
% SYNTAX :
%  [o_tabProfiles] = merge_profile_cts5_usea_ocr_134(a_tabProfiles)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
% RELEASES :
%   03/27/2024 - RNU - creation
% ------------------------------------------------------------------------------
function [o_tabProfiles] = merge_profile_cts5_usea_ocr_134(a_tabProfiles)
...
paramIr1 = get_netcdf_param_attributes('RAW_DOWNWELLING_IRRADIANCE443');
paramIr2 = get_netcdf_param_attributes('RAW_DOWNWELLING_IRRADIANCE490');
paramIr3 = get_netcdf_param_attributes('RAW_DOWNWELLING_IRRADIANCE555');
paramPar = get_netcdf_param_attributes('RAW_DOWNWELLING_PAR');
paramIr1StDev = get_netcdf_param_attributes('RAW_DOWNWELLING_IRRADIANCE443_STD');
paramIr2StDev = get_netcdf_param_attributes('RAW_DOWNWELLING_IRRADIANCE490_STD');
paramIr3StDev = get_netcdf_param_attributes('RAW_DOWNWELLING_IRRADIANCE555_STD');
paramParStDev = get_netcdf_param_attributes('RAW_DOWNWELLING_PAR_STD');
paramPresMed = get_netcdf_param_attributes('PRES_MED');
paramIr1Med = get_netcdf_param_attributes('RAW_DOWNWELLING_IRRADIANCE443_MED');
paramIr2Med = get_netcdf_param_attributes('RAW_DOWNWELLING_IRRADIANCE490_MED');
paramIr3Med = get_netcdf_param_attributes('RAW_DOWNWELLING_IRRADIANCE555_MED');
