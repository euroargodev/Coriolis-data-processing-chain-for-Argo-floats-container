...
if (~isempty(refWmo))
   ...
   for idConfigFile = 1:length(tabConfigFilePathName)
      ...
      if (o_inputError == 0)
         ...
         % decId = 4xx    : NKE floats version 2 (PFV2) with Iridium Sbd transmission => Trans Type = 3
