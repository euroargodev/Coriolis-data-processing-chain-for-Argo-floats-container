...
%
% SYNTAX :
%  [o_tridente3Data] = decode_apmt_tridente3(a_data, a_lastByteNum, a_inputFilePathName)
%
% INPUT PARAMETERS :
...
%
% OUTPUT PARAMETERS :
%   o_tridente3Data : TRIDENTE decoded data
%
% EXAMPLES :
%
% SEE ALSO :
...
% ------------------------------------------------------------------------------
function [o_tridente3Data] = decode_apmt_tridente3(a_data, a_lastByteNum, a_inputFilePathName)
