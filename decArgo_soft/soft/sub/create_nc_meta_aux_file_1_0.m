...
% generate NetCDF-4 flag for META_AUX file
global g_decArgo_netCDF4FlagForMetaAux;
...
if (g_decArgo_netCDF4FlagForMetaAux)
...
try
   ...
   institution = '';
   if (isfield(a_metaDataAux, 'DATA_CENTRE'))
      institution = get_institution_from_data_centre(a_metaDataAux.DATA_CENTRE, 1);
   end
   ...
   if (g_decArgo_netCDF4FlagForMetaAux)
      netcdf.defVarDeflate(fCdf, floatMetaDataNameVarId, SHUFFLE_FLAG, true, g_decArgo_netCDFDeflateLevel);
   end
   ...
   if (g_decArgo_netCDF4FlagForMetaAux)
      netcdf.defVarDeflate(fCdf, floatMetaDataValueVarId, SHUFFLE_FLAG, true, g_decArgo_netCDFDeflateLevel);
   end
   ...
   if (g_decArgo_netCDF4FlagForMetaAux)
      netcdf.defVarDeflate(fCdf, floatMetaDataDescriptionVarId, SHUFFLE_FLAG, true, g_decArgo_netCDFDeflateLevel);
   end
   ...
   if (g_decArgo_netCDF4FlagForMetaAux)
      netcdf.defVarDeflate(fCdf, staticConfigurationParameterNameVarId, SHUFFLE_FLAG, true, g_decArgo_netCDFDeflateLevel);
   end
   ...
   if (g_decArgo_netCDF4FlagForMetaAux)
      netcdf.defVarDeflate(fCdf, staticConfigurationParameterValueVarId, SHUFFLE_FLAG, true, g_decArgo_netCDFDeflateLevel);
   end
   ...
   if (g_decArgo_netCDF4FlagForMetaAux)
      netcdf.defVarDeflate(fCdf, staticConfigurationParameterDescriptionVarId, SHUFFLE_FLAG, true, g_decArgo_netCDFDeflateLevel);
   end
   ...
   if (g_decArgo_netCDF4FlagForMetaAux)
      netcdf.defVarDeflate(fCdf, launchConfigParameterNameVarId, SHUFFLE_FLAG, true, g_decArgo_netCDFDeflateLevel);
   end
   ...
   if (g_decArgo_netCDF4FlagForMetaAux)
      netcdf.defVarDeflate(fCdf, launchConfigParameterValueVarId, SHUFFLE_FLAG, true, g_decArgo_netCDFDeflateLevel);
   end
   ...
   if (g_decArgo_netCDF4FlagForMetaAux)
      netcdf.defVarDeflate(fCdf, launchConfigParameterDescriptionVarId, SHUFFLE_FLAG, true, g_decArgo_netCDFDeflateLevel);
   end
   ...
   if (g_decArgo_netCDF4FlagForMetaAux)
      netcdf.defVarDeflate(fCdf, configParameterNameVarId, SHUFFLE_FLAG, true, g_decArgo_netCDFDeflateLevel);
   end
   ...
   if (g_decArgo_netCDF4FlagForMetaAux)
      netcdf.defVarDeflate(fCdf, configParameterValueVarId, SHUFFLE_FLAG, true, g_decArgo_netCDFDeflateLevel);
   end
   ...
   if (g_decArgo_netCDF4FlagForMetaAux)
      netcdf.defVarDeflate(fCdf, configMissionCommentVarId, SHUFFLE_FLAG, true, g_decArgo_netCDFDeflateLevel);
   end
   ...
   if (g_decArgo_netCDF4FlagForMetaAux)
      netcdf.defVarDeflate(fCdf, sensorVarId, SHUFFLE_FLAG, true, g_decArgo_netCDFDeflateLevel);
   end
   ...
   if (g_decArgo_netCDF4FlagForMetaAux)
      netcdf.defVarDeflate(fCdf, sensorMakerVarId, SHUFFLE_FLAG, true, g_decArgo_netCDFDeflateLevel);
   end
   ...
   if (g_decArgo_netCDF4FlagForMetaAux)
      netcdf.defVarDeflate(fCdf, sensorModelVarId, SHUFFLE_FLAG, true, g_decArgo_netCDFDeflateLevel);
   end
   ...
   if (g_decArgo_netCDF4FlagForMetaAux)
      netcdf.defVarDeflate(fCdf, sensorSerialNoVarId, SHUFFLE_FLAG, true, g_decArgo_netCDFDeflateLevel);
   end
   ...
   sensorFirmwareVersionVarId = netcdf.defVar(fCdf, 'SENSOR_FIRMWARE_VERSION', 'NC_CHAR', fliplr([nSensorDimId string32DimId]));
   if (g_decArgo_netCDF4FlagForMetaAux)
      netcdf.defVarDeflate(fCdf, sensorFirmwareVersionVarId, SHUFFLE_FLAG, true, g_decArgo_netCDFDeflateLevel);
   end
   netcdf.putAtt(fCdf, sensorFirmwareVersionVarId, 'long_name', 'Firmware version of the sensor');
   netcdf.putAtt(fCdf, sensorFirmwareVersionVarId, '_FillValue', ' ');
   floatNcVarId = [floatNcVarId; sensorFirmwareVersionVarId];
   floatNcVarName{end+1} = 'SENSOR_FIRMWARE_VERSION';
   ...
   if (g_decArgo_netCDF4FlagForMetaAux)
      netcdf.defVarDeflate(fCdf, parameterSensorVarId, SHUFFLE_FLAG, true, g_decArgo_netCDFDeflateLevel);
   end
   ...
   if (g_decArgo_netCDF4FlagForMetaAux)
      netcdf.defVarDeflate(fCdf, parameterUnitsVarId, SHUFFLE_FLAG, true, g_decArgo_netCDFDeflateLevel);
   end
   ...
   if (g_decArgo_netCDF4FlagForMetaAux)
      netcdf.defVarDeflate(fCdf, parameterAccuracyVarId, SHUFFLE_FLAG, true, g_decArgo_netCDFDeflateLevel);
   end
   ...
   if (g_decArgo_netCDF4FlagForMetaAux)
      netcdf.defVarDeflate(fCdf, parameterResolutionVarId, SHUFFLE_FLAG, true, g_decArgo_netCDFDeflateLevel);
   end
   ...
   if (g_decArgo_netCDF4FlagForMetaAux)
      netcdf.defVarDeflate(fCdf, predeploymentCalibEquationVarId, SHUFFLE_FLAG, true, g_decArgo_netCDFDeflateLevel);
   end
   ...
   if (g_decArgo_netCDF4FlagForMetaAux)
      netcdf.defVarDeflate(fCdf, predeploymentCalibCoefficientVarId, SHUFFLE_FLAG, true, g_decArgo_netCDFDeflateLevel);
   end
   ...
   if (g_decArgo_netCDF4FlagForMetaAux)
      netcdf.defVarDeflate(fCdf, predeploymentCalibCommentVarId, SHUFFLE_FLAG, true, g_decArgo_netCDFDeflateLevel);
   end
   ...
   for idConf = 1:length(a_launchAuxConfigName)
      ...
      if (~isempty(a_launchAuxConfigId))
         if (iscell(g_decArgo_outputNcConfParamId))
            idF = find(strcmp(a_launchAuxConfigId(idConf), g_decArgo_outputNcConfParamId)); % config name Ids are numbers for NKE floats (except for PFV2 floats) and strings for APF11
            if (~isempty(idF))
               confDescription = g_decArgo_outputNcConfParamDescription{idF};
            end
         else
