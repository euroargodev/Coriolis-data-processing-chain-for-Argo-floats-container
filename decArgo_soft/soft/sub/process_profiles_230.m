...
%
% SYNTAX :
% [o_tabProfiles] = process_profiles_230( ...
...
%   a_ascProfTempCountDoxy, a_ascProfCountDoxy, a_ascProfLedFlashingCountDoxy, a_ascProfTempDoxy2, a_ascProfDoxy2, ...
...
%   a_ascProfTempCountDoxy         : ascending profile TEMP_COUNT_DOXY
%   a_ascProfCountDoxy             : ascending profile COUNT_DOXY
%   a_ascProfLedFlashingCountDoxy  : ascending profile LED_FLASHING_COUNT_DOXY DOXY
%   a_ascProfTempDoxy2             : ascending profile TEMP_DOXY2
%   a_ascProfDoxy2                 : ascending profile DOXY2
%   a_gpsData                      : GPS data
...
% ------------------------------------------------------------------------------
function [o_tabProfiles] = process_profiles_230( ...
   a_descProfDate, a_descProfDateAdj, a_descProfPres, a_descProfTemp, a_descProfSal, ...
   a_descProfC1PhaseDoxy, a_descProfC2PhaseDoxy, a_descProfTempDoxy, a_descProfDoxy, ...
   a_descProfTempCountDoxy, a_descProfCountDoxy, a_descProfLedFlashingCountDoxy, a_descProfTempDoxy2, a_descProfDoxy2, ...
   a_ascProfDate, a_ascProfDateAdj, a_ascProfPres, a_ascProfTemp, a_ascProfSal, ...
...
for idProf = 1:3
   ...
   if (idProf == 1)
      ...
      tabTempCountDoxy = a_descProfTempCountDoxy;
      tabCountDoxy = a_descProfCountDoxy;
      tabLedFlashingCountDoxy = a_descProfLedFlashingCountDoxy;
      tabTempDoxy2 = a_descProfTempDoxy2;
      tabDoxy2 = a_descProfDoxy2;
      ...
      tabTempCountDoxy = flipud(tabTempCountDoxy);
      tabCountDoxy = flipud(tabCountDoxy);
      tabLedFlashingCountDoxy = flipud(tabLedFlashingCountDoxy);
      tabTempDoxy2 = flipud(tabTempDoxy2);
      tabDoxy2 = flipud(tabDoxy2);
      ...
      if (idProf == 2)
         ...
         if (~isempty(idLev))
            ...
            tabTempCountDoxy = a_ascProfTempCountDoxy(1:idLev(end));
            tabCountDoxy = a_ascProfCountDoxy(1:idLev(end));
            tabLedFlashingCountDoxy = a_ascProfLedFlashingCountDoxy(1:idLev(end));
            tabTempDoxy2 = a_ascProfTempDoxy2(1:idLev(end));
            tabDoxy2 = a_ascProfDoxy2(1:idLev(end));
         end
      else
         % unpumped profile
         if (~isempty(subSurfacePres))
         ...
         if (~isempty(idLev))
            ...
            tabTempCountDoxy = a_ascProfTempCountDoxy(idLev(1):end);
            tabCountDoxy = a_ascProfCountDoxy(idLev(1):end);
            tabLedFlashingCountDoxy = a_ascProfLedFlashingCountDoxy(idLev(1):end);
            tabTempDoxy2 = a_ascProfTempDoxy2(idLev(1):end);
            tabDoxy2 = a_ascProfDoxy2(idLev(1):end);
         end
      end
   ...
   if (~isempty(tabDate))
      ...
      tabTempCountDoxy(find(tabTempCountDoxy == g_decArgo_tempDoxyCountsDef)) = paramTempCountDoxy.fillValue;
      tabCountDoxy(find(tabCountDoxy == g_decArgo_doxyCountsDef)) = paramCountDoxy.fillValue;
      tabLedFlashingCountDoxy(find(tabLedFlashingCountDoxy == g_decArgo_ledFlashingDoxyCountsDef)) = paramLedFlashingCountDoxy.fillValue;
      tabTempDoxy2(find(tabTempDoxy2 == g_decArgo_tempDoxyDef)) = paramTempDoxy2.fillValue;
      tabDoxy2(find(tabDoxy2 == g_decArgo_doxyDef)) = paramDoxy2.fillValue;
      ...
      profStruct.data = [tabPres tabTemp tabSal ...
         tabC1PhaseDoxy tabC2PhaseDoxy tabTempDoxy tabDoxy ...
         tabTempCountDoxy tabCountDoxy tabLedFlashingCountDoxy tabTempDoxy2 tabDoxy2];
...
if (~isempty(configNames))
   ...
   if (~isempty(a_tabTech))
      if (a_tabTech(20) == 0)
         go = 0;
      elseif (a_tabTech(20) == 1)
         if (~isempty(parkPres) && ~isempty(profilePres))
            if ~(((parkPres == profilePres) && ((a_tabTech(24) == 3) || (a_tabTech(24) == 5))) || ...
                  ((parkPres ~= profilePres) && (a_tabTech(24) == 5)))
               go = 0;
            end
         end
      end
