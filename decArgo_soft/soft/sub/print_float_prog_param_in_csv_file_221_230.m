...
%
% SYNTAX :
%  print_float_prog_param_in_csv_file_221_230(a_floatParam1, a_floatParam2)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function print_float_prog_param_in_csv_file_221_230(a_floatParam1, a_floatParam2)
...
elseif (size(a_floatParam1, 1) == 1)
   ...
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Prog #1; PT4: Pump duration during buoyancy acquisition; %d; csec\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_floatParam1(id, 30+ID_OFFSET)*1000);
