...
o_profStruct = struct( ...
   ...
   'posSystem2', '', ...
   'vertSamplingScheme', ' ', ...
   'additionnalBottomThreshold', [], ... % additionnal depth zone created only after grounding (PM18 of decId 221 and 230)
   'paramList', [], ...
   'paramDataMode', [], ...
   ...
   'dates', [], ...
   'datesAdj', [], ...
   'datesTransFlag', [], ... % 1 if the date is transmitted by the float 0 otherwise
   ...
   'presCutOffProf', g_decArgo_presDef, ... % cut-off pressure of the ascending PTS profile
   'presCutOffProfConfig', -1, ... % presCutOffProf set from configuration
   'presOffset', '', ...
   ...
   'bounceFlag', '', ... 
   'rbrFlag', '' ... % used for Arvor Deep 3T prototype (decId 228) to identify RBR data profile (for VSS generation)
   );
