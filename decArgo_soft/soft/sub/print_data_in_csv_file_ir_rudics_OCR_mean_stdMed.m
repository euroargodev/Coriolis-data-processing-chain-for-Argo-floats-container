...
if (isempty(idDataStdMed))
   ...
   dataMean(:, 8) = compute_DOWN_IRRADIANCE380_105_to_112_121_to_133_135_to_141(dataMean(:, 4), g_decArgo_iradianceCountsDef, paramDOWN_IRRADIANCE380.fillValue);
   paramDOWN_IRRADIANCE412 = get_netcdf_param_attributes('DOWN_IRRADIANCE412');
   dataMean(:, 9) = compute_DOWN_IRRADIANCE412_105_to_112_121_to_132_135_to_137_141(dataMean(:, 5), g_decArgo_iradianceCountsDef, paramDOWN_IRRADIANCE412.fillValue);
   paramDOWN_IRRADIANCE490 = get_netcdf_param_attributes('DOWN_IRRADIANCE490');
   dataMean(:, 10) = compute_DOWN_IRRADIANCE490_105_to_112_121_to_133_135_to_141(dataMean(:, 6), g_decArgo_iradianceCountsDef, paramDOWN_IRRADIANCE490.fillValue);
   paramDOWNWELLING_PAR = get_netcdf_param_attributes('DOWNWELLING_PAR');
   dataMean(:, 11) = compute_DOWNWELLING_PAR_1xx_5_to_12_21_to_29_32_35_to_37_41(dataMean(:, 7), g_decArgo_iradianceCountsDef, paramDOWNWELLING_PAR.fillValue);
   ...
   if (isempty(idDataMean))
      ...
      paramDOWN_IRRADIANCE380 = get_netcdf_param_attributes('DOWN_IRRADIANCE380');
      data(:, 16) = compute_DOWN_IRRADIANCE380_105_to_112_121_to_133_135_to_141(data(:, 4), g_decArgo_iradianceCountsDef, paramDOWN_IRRADIANCE380.fillValue);
      paramDOWN_IRRADIANCE412 = get_netcdf_param_attributes('DOWN_IRRADIANCE412');
      data(:, 17) = compute_DOWN_IRRADIANCE412_105_to_112_121_to_132_135_to_137_141(data(:, 5), g_decArgo_iradianceCountsDef, paramDOWN_IRRADIANCE412.fillValue);
      paramDOWN_IRRADIANCE490 = get_netcdf_param_attributes('DOWN_IRRADIANCE490');
      data(:, 18) = compute_DOWN_IRRADIANCE490_105_to_112_121_to_133_135_to_141(data(:, 6), g_decArgo_iradianceCountsDef, paramDOWN_IRRADIANCE490.fillValue);
      paramDOWNWELLING_PAR = get_netcdf_param_attributes('DOWNWELLING_PAR');
      data(:, 19) = compute_DOWNWELLING_PAR_1xx_5_to_12_21_to_29_32_35_to_37_41(data(:, 7), g_decArgo_iradianceCountsDef, paramDOWNWELLING_PAR.fillValue);
