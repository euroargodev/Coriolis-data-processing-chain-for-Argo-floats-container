...
%
% SYNTAX :
%  [o_tridente9Data] = decode_apmt_tridente9(a_data, a_lastByteNum, a_inputFilePathName)
%
% INPUT PARAMETERS :
%   a_data              : input TRIDENTE data to decode
%   a_lastByteNum       : number of the last useful byte of the data
%   a_inputFilePathName : APMT TRIDENTE file to decode
%
% OUTPUT PARAMETERS :
%   o_tridente9Data : TRIDENTE decoded data
%
% EXAMPLES :
%
% SEE ALSO :
...
% ------------------------------------------------------------------------------
function [o_tridente9Data] = decode_apmt_tridente9(a_data, a_lastByteNum, a_inputFilePathName)
