...
% ------------------------------------------------------------------------------
% RELEASES :
%   07/01/2025 - RNU - creation
% ------------------------------------------------------------------------------
function [o_floatbuffers] = create_decoding_buffers_402(a_floatData)
...
if (~isempty(g_decArgo_outputCsvFileId))
   for idT = idTech2
      idSensor = find([a_floatData{idT, 5}.techId] == 900004);
      if (~isempty(idSensor))
         idPhase = find([a_floatData{idT, 5}.techId] == 900003);
         idZ1 = find([a_floatData{idT, 5}.techId] == 900005);
         idZ2 = find([a_floatData{idT, 5}.techId] == 900007);
         idZ3 = find([a_floatData{idT, 5}.techId] == 900009);
         idZ4 = find([a_floatData{idT, 5}.techId] == 900011);
         idZ5 = find([a_floatData{idT, 5}.techId] == 900013);
      ...
      idSensor = find([a_floatData{idT, 5}.techId] == 900104);
      if (~isempty(idSensor))
         idPhase = find([a_floatData{idT, 5}.techId] == 900103);
         idNb = find([a_floatData{idT, 5}.techId] == 900105);
         for id = 1:length(idSensor)
            sensorNum = str2double(a_floatData{idT, 5}(idSensor(id)).valueStr);
            phaseNum = str2double(a_floatData{idT, 5}(idPhase(id)).valueStr);
   ...
   for idT = idTech2
      idTech = find(ismember([a_floatData{idT, 5}.techId], [900015, 900016, 900017, 900106, 900107, 900108]));
