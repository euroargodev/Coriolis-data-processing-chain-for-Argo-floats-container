...
% ------------------------------------------------------------------------------
function [o_techSectionList, o_techInfoStruct] = init_tech_info_struct_139_140
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
intPresTempComp = init_basic_struct;
intPresTempComp.pattern = 'Pi temp=%f mbar';
intPresTempComp.count = 1;

intPresTempComp.id{end+1} = 1;
intPresTempComp.name{end+1} = 'internal pressure compensated in temperature (mbar)';
intPresTempComp.fmt{end+1} = '%g';
intPresTempComp.tech{end+1} = get_cts5_tech_data_init_struct(271, 'Internal pressure compensated in temperature (mbar)');
...
o_techInfoStruct.SYSTEM{end+1} = intPresTempComp;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
eventFileReceived = init_basic_struct;
eventFileReceived.pattern = 'Download=event file';
eventFileReceived.count = 0;

eventFileReceived.id{end+1} = 1;
eventFileReceived.name{end+1} = 'event file received';
eventFileReceived.tech{end+1} = get_cts5_tech_data_init_struct(272, 'Event file received');

% removed because it seems to be an error in the manual (NKE information)
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% payloadFileReceived = init_basic_struct;
% payloadFileReceived.pattern = 'Download=payload file';
% payloadFileReceived.count = 0;
% 
% payloadFileReceived.id{end+1} = 1;
% payloadFileReceived.name{end+1} = 'payload file received';
% payloadFileReceived.tech{end+1} = get_cts5_tech_data_init_struct(273, 'Payload file received');
...
numberOfSamplesSBE41.pattern = 'SBE41=%u/%u/%u/%u/%u/%u/%u points (%u/%u)';
numberOfSamplesSBE41.count = 9;
...
numberOfSamplesSBE41.id{end+1} = 8;
numberOfSamplesSBE41.name{end+1} = 'number of SBE41 samples removed by the decimation process';
numberOfSamplesSBE41.fmt{end+1} = '%d';
numberOfSamplesSBE41.tech{end+1} = get_cts5_tech_data_init_struct(274, 'Number of SBE41 samples removed by the decimation process');
numberOfSamplesSBE41.tech{end}.shortSensorName = 'Ctd';

numberOfSamplesSBE41.id{end+1} = 9;
numberOfSamplesSBE41.name{end+1} = 'total number of SBE41 samples acquired';
numberOfSamplesSBE41.fmt{end+1} = '%d';
numberOfSamplesSBE41.tech{end+1} = get_cts5_tech_data_init_struct(275, 'Total number of SBE41 samples acquired');
numberOfSamplesSBE41.tech{end}.shortSensorName = 'Ctd';

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
numberOfSamplesDO = init_basic_struct;
numberOfSamplesDO.pattern = 'DO=%u/%u/%u/%u/%u/%u points (%u/%u)';
numberOfSamplesDO.count = 8;
...
numberOfSamplesDO.id{end+1} = 7;
numberOfSamplesDO.name{end+1} = 'number of DO samples removed by the decimation process';
numberOfSamplesDO.fmt{end+1} = '%d';
numberOfSamplesDO.tech{end+1} = get_cts5_tech_data_init_struct(274, 'Number of DO samples removed by the decimation process');
numberOfSamplesDO.tech{end}.shortSensorName = 'Optode';

numberOfSamplesDO.id{end+1} = 8;
numberOfSamplesDO.name{end+1} = 'total number of DO samples acquired';
numberOfSamplesDO.fmt{end+1} = '%d';
numberOfSamplesDO.tech{end+1} = get_cts5_tech_data_init_struct(275, 'Total number of DO samples acquired');
numberOfSamplesDO.tech{end}.shortSensorName = 'Optode';

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
numberOfSamplesOCR = init_basic_struct;
numberOfSamplesOCR.pattern = 'OCR=%u/%u/%u/%u/%u/%u points (%u/%u)';
numberOfSamplesOCR.count = 8;
...
numberOfSamplesOCR.id{end+1} = 7;
numberOfSamplesOCR.name{end+1} = 'number of OCR samples removed by the decimation process';
numberOfSamplesOCR.fmt{end+1} = '%d';
numberOfSamplesOCR.tech{end+1} = get_cts5_tech_data_init_struct(274, 'Number of OCR samples removed by the decimation process');
numberOfSamplesOCR.tech{end}.shortSensorName = 'Ocr';

numberOfSamplesOCR.id{end+1} = 8;
numberOfSamplesOCR.name{end+1} = 'total number of OCR samples acquired';
numberOfSamplesOCR.fmt{end+1} = '%d';
numberOfSamplesOCR.tech{end+1} = get_cts5_tech_data_init_struct(275, 'Total number of OCR samples acquired');
numberOfSamplesOCR.tech{end}.shortSensorName = 'Ocr';

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
numberOfSamplesECO = init_basic_struct;
numberOfSamplesECO.pattern = 'ECO=%u/%u/%u/%u/%u/%u points (%u/%u)';
numberOfSamplesECO.count = 8;
...
numberOfSamplesECO.id{end+1} = 7;
numberOfSamplesECO.name{end+1} = 'number of ECO samples removed by the decimation process';
numberOfSamplesECO.fmt{end+1} = '%d';
numberOfSamplesECO.tech{end+1} = get_cts5_tech_data_init_struct(274, 'Number of ECO samples removed by the decimation process');
numberOfSamplesECO.tech{end}.shortSensorName = 'Eco';

numberOfSamplesECO.id{end+1} = 8;
numberOfSamplesECO.name{end+1} = 'total number of ECO samples acquired';
numberOfSamplesECO.fmt{end+1} = '%d';
numberOfSamplesECO.tech{end+1} = get_cts5_tech_data_init_struct(275, 'Total number of ECO samples acquired');
numberOfSamplesECO.tech{end}.shortSensorName = 'Eco';

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
numberOfSamplesCROVER = init_basic_struct;
numberOfSamplesCROVER.pattern = 'CROVER=%u/%u/%u/%u/%u/%u points (%u/%u)';
numberOfSamplesCROVER.count = 8;
...
numberOfSamplesCROVER.id{end+1} = 7;
numberOfSamplesCROVER.name{end+1} = 'number of CROVER samples removed by the decimation process';
numberOfSamplesCROVER.fmt{end+1} = '%d';
numberOfSamplesCROVER.tech{end+1} = get_cts5_tech_data_init_struct(274, 'Number of CROVER samples removed by the decimation process');
numberOfSamplesCROVER.tech{end}.shortSensorName = 'Crover';

numberOfSamplesCROVER.id{end+1} = 8;
numberOfSamplesCROVER.name{end+1} = 'total number of CROVER samples acquired';
numberOfSamplesCROVER.fmt{end+1} = '%d';
numberOfSamplesCROVER.tech{end+1} = get_cts5_tech_data_init_struct(275, 'Total number of CROVER samples acquired');
numberOfSamplesCROVER.tech{end}.shortSensorName = 'Crover';

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
numberOfSamplesSBEPH = init_basic_struct;
numberOfSamplesSBEPH.pattern = 'SBEPH=%u/%u/%u/%u/%u/%u points (%u/%u)';
numberOfSamplesSBEPH.count = 8;
...
numberOfSamplesSBEPH.id{end+1} = 7;
numberOfSamplesSBEPH.name{end+1} = 'number of SBEPH samples removed by the decimation process';
numberOfSamplesSBEPH.fmt{end+1} = '%d';
numberOfSamplesSBEPH.tech{end+1} = get_cts5_tech_data_init_struct(274, 'Number of SBEPH samples removed by the decimation process');
numberOfSamplesSBEPH.tech{end}.shortSensorName = 'Sfet';

numberOfSamplesSBEPH.id{end+1} = 8;
numberOfSamplesSBEPH.name{end+1} = 'total number of SBEPH samples acquired';
numberOfSamplesSBEPH.fmt{end+1} = '%d';
numberOfSamplesSBEPH.tech{end+1} = get_cts5_tech_data_init_struct(275, 'Total number of SBEPH samples acquired');
numberOfSamplesSBEPH.tech{end}.shortSensorName = 'Sfet';

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
numberOfSamplesSUNA = init_basic_struct;
numberOfSamplesSUNA.pattern = 'SUNA=%u/%u/%u/%u/%u/%u points (%u/%u)';
numberOfSamplesSUNA.count = 8;
...
numberOfSamplesSUNA.id{end+1} = 7;
numberOfSamplesSUNA.name{end+1} = 'number of SUNA samples removed by the decimation process';
numberOfSamplesSUNA.fmt{end+1} = '%d';
numberOfSamplesSUNA.tech{end+1} = get_cts5_tech_data_init_struct(274, 'Number of SUNA samples removed by the decimation process');
numberOfSamplesSUNA.tech{end}.shortSensorName = 'Suna';

numberOfSamplesSUNA.id{end+1} = 8;
numberOfSamplesSUNA.name{end+1} = 'total number of SUNA samples acquired';
numberOfSamplesSUNA.fmt{end+1} = '%d';
numberOfSamplesSUNA.tech{end+1} = get_cts5_tech_data_init_struct(275, 'Total number of SUNA samples acquired');
numberOfSamplesSUNA.tech{end}.shortSensorName = 'Suna';

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
numberOfSamplesUvp6Lpm = init_basic_struct;
numberOfSamplesUvp6Lpm.pattern = 'UVP6-LPM=%u/%u/%u/%u/%u/%u points (%u/%u)';
numberOfSamplesUvp6Lpm.count = 8;
...
numberOfSamplesUvp6Lpm.id{end+1} = 7;
numberOfSamplesUvp6Lpm.name{end+1} = 'number of UVP6-LPM samples removed by the decimation process';
numberOfSamplesUvp6Lpm.fmt{end+1} = '%d';
numberOfSamplesUvp6Lpm.tech{end+1} = get_cts5_tech_data_init_struct(274, 'Number of UVP6-LPM samples removed by the decimation process');
numberOfSamplesUvp6Lpm.tech{end}.shortSensorName = 'UvpLpm';

numberOfSamplesUvp6Lpm.id{end+1} = 8;
numberOfSamplesUvp6Lpm.name{end+1} = 'total number of UVP6-LPM samples acquired';
numberOfSamplesUvp6Lpm.fmt{end+1} = '%d';
numberOfSamplesUvp6Lpm.tech{end+1} = get_cts5_tech_data_init_struct(275, 'Total number of UVP6-LPM samples acquired');
numberOfSamplesUvp6Lpm.tech{end}.shortSensorName = 'UvpLpm';

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
numberOfSamplesUvp6Txo = init_basic_struct;
numberOfSamplesUvp6Txo.pattern = 'UVP6-TXO=%u/%u/%u/%u/%u/%u points (%u/%u)';
numberOfSamplesUvp6Txo.count = 8;
...
numberOfSamplesUvp6Txo.id{end+1} = 7;
numberOfSamplesUvp6Txo.name{end+1} = 'number of UVP6-TXO samples removed by the decimation process';
numberOfSamplesUvp6Txo.fmt{end+1} = '%d';
numberOfSamplesUvp6Txo.tech{end+1} = get_cts5_tech_data_init_struct(274, 'Number of UVP6-TXO samples removed by the decimation process');
numberOfSamplesUvp6Txo.tech{end}.shortSensorName = 'UvpTxo';

numberOfSamplesUvp6Txo.id{end+1} = 8;
numberOfSamplesUvp6Txo.name{end+1} = 'total number of UVP6-TXO samples acquired';
numberOfSamplesUvp6Txo.fmt{end+1} = '%d';
numberOfSamplesUvp6Txo.tech{end+1} = get_cts5_tech_data_init_struct(275, 'Total number of UVP6-TXO samples acquired');
numberOfSamplesUvp6Txo.tech{end}.shortSensorName = 'UvpTxo';

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
numberOfSamplesUvp6Blk = init_basic_struct;
numberOfSamplesUvp6Blk.pattern = 'UVP6-BLK=%u/%u/%u/%u/%u/%u points (%u/%u)';
numberOfSamplesUvp6Blk.count = 8;
...
numberOfSamplesUvp6Blk.id{end+1} = 7;
numberOfSamplesUvp6Blk.name{end+1} = 'number of UVP6-BLK samples removed by the decimation process';
numberOfSamplesUvp6Blk.fmt{end+1} = '%d';
numberOfSamplesUvp6Blk.tech{end+1} = get_cts5_tech_data_init_struct(274, 'Number of UVP6-BLK samples removed by the decimation process');
numberOfSamplesUvp6Blk.tech{end}.shortSensorName = 'UvpBlk';

numberOfSamplesUvp6Blk.id{end+1} = 8;
numberOfSamplesUvp6Blk.name{end+1} = 'total number of UVP6-BLK samples acquired';
numberOfSamplesUvp6Blk.fmt{end+1} = '%d';
numberOfSamplesUvp6Blk.tech{end+1} = get_cts5_tech_data_init_struct(275, 'Total number of UVP6-BLK samples acquired');
numberOfSamplesUvp6Blk.tech{end}.shortSensorName = 'UvpBlk';

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
numberOfSamplesExtTrig = init_basic_struct;
numberOfSamplesExtTrig.pattern = 'EXT-TRIG=%u/%u/%u/%u/%u/%u points (%u/%u)';
numberOfSamplesExtTrig.count = 8;
...
numberOfSamplesExtTrig.id{end+1} = 7;
numberOfSamplesExtTrig.name{end+1} = 'number of EXT-TRIG samples removed by the decimation process';
numberOfSamplesExtTrig.fmt{end+1} = '%d';
numberOfSamplesExtTrig.tech{end+1} = get_cts5_tech_data_init_struct(274, 'Number of EXT-TRIG samples removed by the decimation process');
numberOfSamplesExtTrig.tech{end}.shortSensorName = 'ExtTrig';

numberOfSamplesExtTrig.id{end+1} = 8;
numberOfSamplesExtTrig.name{end+1} = 'total number of EXT-TRIG samples acquired';
numberOfSamplesExtTrig.fmt{end+1} = '%d';
numberOfSamplesExtTrig.tech{end+1} = get_cts5_tech_data_init_struct(275, 'Total number of EXT-TRIG samples acquired');
numberOfSamplesExtTrig.tech{end}.shortSensorName = 'ExtTrig';

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
numberOfSamplesRAMSES = init_basic_struct;
numberOfSamplesRAMSES.pattern = 'RAMSES=%u/%u/%u/%u/%u/%u points (%u/%u)';
numberOfSamplesRAMSES.count = 8;
...
numberOfSamplesRAMSES.id{end+1} = 7;
numberOfSamplesRAMSES.name{end+1} = 'number of RAMSES samples removed by the decimation process';
numberOfSamplesRAMSES.fmt{end+1} = '%d';
numberOfSamplesRAMSES.tech{end+1} = get_cts5_tech_data_init_struct(274, 'Number of RAMSES samples removed by the decimation process');
numberOfSamplesRAMSES.tech{end}.shortSensorName = 'Ramses';

numberOfSamplesRAMSES.id{end+1} = 8;
numberOfSamplesRAMSES.name{end+1} = 'total number of RAMSES samples acquired';
numberOfSamplesRAMSES.fmt{end+1} = '%d';
numberOfSamplesRAMSES.tech{end+1} = get_cts5_tech_data_init_struct(275, 'Total number of RAMSES samples acquired');
numberOfSamplesRAMSES.tech{end}.shortSensorName = 'Ramses';

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
numberOfSamplesRAMSES2 = init_basic_struct;
numberOfSamplesRAMSES2.pattern = 'RAMSES2=%u/%u/%u/%u/%u/%u points (%u/%u)';
numberOfSamplesRAMSES2.count = 8;
...
numberOfSamplesRAMSES2.id{end+1} = 7;
numberOfSamplesRAMSES2.name{end+1} = 'number of RAMSES2 samples removed by the decimation process';
numberOfSamplesRAMSES2.fmt{end+1} = '%d';
numberOfSamplesRAMSES2.tech{end+1} = get_cts5_tech_data_init_struct(274, 'Number of RAMSES2 samples removed by the decimation process');
numberOfSamplesRAMSES2.tech{end}.shortSensorName = 'Ramses2';

numberOfSamplesRAMSES2.id{end+1} = 8;
numberOfSamplesRAMSES2.name{end+1} = 'total number of RAMSES2 samples acquired';
numberOfSamplesRAMSES2.fmt{end+1} = '%d';
numberOfSamplesRAMSES2.tech{end+1} = get_cts5_tech_data_init_struct(275, 'Total number of RAMSES2 samples acquired');
numberOfSamplesRAMSES2.tech{end}.shortSensorName = 'Ramses2';

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
numberOfSamplesOpusLgt = init_basic_struct;
numberOfSamplesOpusLgt.pattern = 'OPUS-LGT=%u/%u/%u/%u/%u/%u points (%u/%u)';
numberOfSamplesOpusLgt.count = 8;
...
numberOfSamplesOpusLgt.id{end+1} = 7;
numberOfSamplesOpusLgt.name{end+1} = 'number of OPUS-LGT samples removed by the decimation process';
numberOfSamplesOpusLgt.fmt{end+1} = '%d';
numberOfSamplesOpusLgt.tech{end+1} = get_cts5_tech_data_init_struct(274, 'Number of OPUS-LGT samples removed by the decimation process');
numberOfSamplesOpusLgt.tech{end}.shortSensorName = 'OpusLgt';

numberOfSamplesOpusLgt.id{end+1} = 8;
numberOfSamplesOpusLgt.name{end+1} = 'total number of OPUS-LGT samples acquired';
numberOfSamplesOpusLgt.fmt{end+1} = '%d';
numberOfSamplesOpusLgt.tech{end+1} = get_cts5_tech_data_init_struct(275, 'Total number of OPUS-LGT samples acquired');
numberOfSamplesOpusLgt.tech{end}.shortSensorName = 'OpusLgt';

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
numberOfSamplesOpusBlk = init_basic_struct;
numberOfSamplesOpusBlk.pattern = 'OPUS-BLK=%u/%u/%u/%u/%u/%u points (%u/%u)';
numberOfSamplesOpusBlk.count = 8;
...
numberOfSamplesOpusBlk.id{end+1} = 7;
numberOfSamplesOpusBlk.name{end+1} = 'number of OPUS-BLK samples removed by the decimation process';
numberOfSamplesOpusBlk.fmt{end+1} = '%d';
numberOfSamplesOpusBlk.tech{end+1} = get_cts5_tech_data_init_struct(274, 'Number of OPUS-BLK samples removed by the decimation process');
numberOfSamplesOpusBlk.tech{end}.shortSensorName = 'OpusBlk';

numberOfSamplesOpusBlk.id{end+1} = 8;
numberOfSamplesOpusBlk.name{end+1} = 'total number of OPUS-BLK samples acquired';
numberOfSamplesOpusBlk.fmt{end+1} = '%d';
numberOfSamplesOpusBlk.tech{end+1} = get_cts5_tech_data_init_struct(275, 'Total number of OPUS-BLK samples acquired');
numberOfSamplesOpusBlk.tech{end}.shortSensorName = 'OpusBlk';

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
numberOfSamplesMPE = init_basic_struct;
numberOfSamplesMPE.pattern = 'MPE=%u/%u/%u/%u/%u/%u points (%u/%u)';
numberOfSamplesMPE.count = 8;
...
numberOfSamplesMPE.id{end+1} = 7;
numberOfSamplesMPE.name{end+1} = 'number of MPE samples removed by the decimation process';
numberOfSamplesMPE.fmt{end+1} = '%d';
numberOfSamplesMPE.tech{end+1} = get_cts5_tech_data_init_struct(274, 'Number of MPE samples removed by the decimation process');
numberOfSamplesMPE.tech{end}.shortSensorName = 'Mpe';

numberOfSamplesMPE.id{end+1} = 8;
numberOfSamplesMPE.name{end+1} = 'total number of MPE samples acquired';
numberOfSamplesMPE.fmt{end+1} = '%d';
numberOfSamplesMPE.tech{end+1} = get_cts5_tech_data_init_struct(275, 'Total number of MPE samples acquired');
numberOfSamplesMPE.tech{end}.shortSensorName = 'Mpe';

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
numberOfSamplesHydrocM = init_basic_struct;
numberOfSamplesHydrocM.pattern = 'HYDROC-M=%u/%u/%u/%u/%u/%u points (%u/%u)';
numberOfSamplesHydrocM.count = 8;
...
numberOfSamplesHydrocM.id{end+1} = 7;
numberOfSamplesHydrocM.name{end+1} = 'number of HYDROC-M samples removed by the decimation process';
numberOfSamplesHydrocM.fmt{end+1} = '%d';
numberOfSamplesHydrocM.tech{end+1} = get_cts5_tech_data_init_struct(274, 'Number of HYDROC-M samples removed by the decimation process');
numberOfSamplesHydrocM.tech{end}.shortSensorName = 'HydrocM';

numberOfSamplesHydrocM.id{end+1} = 8;
numberOfSamplesHydrocM.name{end+1} = 'total number of HYDROC-M samples acquired';
numberOfSamplesHydrocM.fmt{end+1} = '%d';
numberOfSamplesHydrocM.tech{end+1} = get_cts5_tech_data_init_struct(275, 'Total number of HYDROC-M samples acquired');
numberOfSamplesHydrocM.tech{end}.shortSensorName = 'HydrocM';

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
numberOfSamplesHydrocC = init_basic_struct;
numberOfSamplesHydrocC.pattern = 'HYDROC-C=%u/%u/%u/%u/%u/%u points (%u/%u)';
numberOfSamplesHydrocC.count = 8;
...
numberOfSamplesHydrocC.id{end+1} = 7;
numberOfSamplesHydrocC.name{end+1} = 'number of HYDROC-C samples removed by the decimation process';
numberOfSamplesHydrocC.fmt{end+1} = '%d';
numberOfSamplesHydrocC.tech{end+1} = get_cts5_tech_data_init_struct(274, 'Number of HYDROC-C samples removed by the decimation process');
numberOfSamplesHydrocC.tech{end}.shortSensorName = 'HydrocC';

numberOfSamplesHydrocC.id{end+1} = 8;
numberOfSamplesHydrocC.name{end+1} = 'total number of HYDROC-C samples acquired';
numberOfSamplesHydrocC.fmt{end+1} = '%d';
numberOfSamplesHydrocC.tech{end+1} = get_cts5_tech_data_init_struct(275, 'Total number of HYDROC-C samples acquired');
numberOfSamplesHydrocC.tech{end}.shortSensorName = 'HydrocC';

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
numberOfSamplesIMU = init_basic_struct;
numberOfSamplesIMU.pattern = 'IMU=%u/%u/%u/%u/%u/%u points (%u/%u)';
numberOfSamplesIMU.count = 8;
...
numberOfSamplesIMU.id{end+1} = 7;
numberOfSamplesIMU.name{end+1} = 'number of IMU samples removed by the decimation process';
numberOfSamplesIMU.fmt{end+1} = '%d';
numberOfSamplesIMU.tech{end+1} = get_cts5_tech_data_init_struct(274, 'Number of IMU samples removed by the decimation process');
numberOfSamplesIMU.tech{end}.shortSensorName = 'Imu';

numberOfSamplesIMU.id{end+1} = 8;
numberOfSamplesIMU.name{end+1} = 'total number of IMU samples acquired';
numberOfSamplesIMU.fmt{end+1} = '%d';
numberOfSamplesIMU.tech{end+1} = get_cts5_tech_data_init_struct(275, 'Total number of IMU samples acquired');
numberOfSamplesIMU.tech{end}.shortSensorName = 'Imu';
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
numberOfSamplesPAL = init_basic_struct;
numberOfSamplesPAL.pattern = 'PAL=%u/%u/%u/%u/%u/%u points (%u/%u)';
numberOfSamplesPAL.count = 8;

numberOfSamplesPAL.id{end+1} = 1;
numberOfSamplesPAL.name{end+1} = 'number of PAL samples during descent to parking depth';
numberOfSamplesPAL.fmt{end+1} = '%d';
numberOfSamplesPAL.tech{end+1} = get_cts5_tech_data_init_struct(216, 'Number of PAL samples during descent to parking depth');
numberOfSamplesPAL.tech{end}.shortSensorName = 'Pal';

numberOfSamplesPAL.id{end+1} = 2;
numberOfSamplesPAL.name{end+1} = 'number of PAL samples during drift at parking depth';
numberOfSamplesPAL.fmt{end+1} = '%d';
numberOfSamplesPAL.tech{end+1} = get_cts5_tech_data_init_struct(217, 'Number of PAL samples during drift at parking depth');
numberOfSamplesPAL.tech{end}.shortSensorName = 'Pal';

numberOfSamplesPAL.id{end+1} = 3;
numberOfSamplesPAL.name{end+1} = 'number of PAL samples during descent to profile depth';
numberOfSamplesPAL.fmt{end+1} = '%d';
numberOfSamplesPAL.tech{end+1} = get_cts5_tech_data_init_struct(218, 'Number of PAL samples during descent to profile depth');
numberOfSamplesPAL.tech{end}.shortSensorName = 'Pal';

numberOfSamplesPAL.id{end+1} = 4;
numberOfSamplesPAL.name{end+1} = 'number of PAL samples during drift at profile depth';
numberOfSamplesPAL.fmt{end+1} = '%d';
numberOfSamplesPAL.tech{end+1} = get_cts5_tech_data_init_struct(219, 'Number of PAL samples during drift at profile depth');
numberOfSamplesPAL.tech{end}.shortSensorName = 'Pal';

numberOfSamplesPAL.id{end+1} = 5;
numberOfSamplesPAL.name{end+1} = 'number of PAL samples during ascent to surface';
numberOfSamplesPAL.fmt{end+1} = '%d';
numberOfSamplesPAL.tech{end+1} = get_cts5_tech_data_init_struct(220, 'Number of PAL samples during ascent to surface');
numberOfSamplesPAL.tech{end}.shortSensorName = 'Pal';

numberOfSamplesPAL.id{end+1} = 6;
numberOfSamplesPAL.name{end+1} = 'number of PAL surface samples';
numberOfSamplesPAL.fmt{end+1} = '%d';
numberOfSamplesPAL.tech{end+1} = get_cts5_tech_data_init_struct(221, 'Number of PAL surface samples');
numberOfSamplesPAL.tech{end}.shortSensorName = 'Pal';

numberOfSamplesPAL.id{end+1} = 7;
numberOfSamplesPAL.name{end+1} = 'number of PAL samples removed by the decimation process';
numberOfSamplesPAL.fmt{end+1} = '%d';
numberOfSamplesPAL.tech{end+1} = get_cts5_tech_data_init_struct(274, 'Number of PAL samples removed by the decimation process');
numberOfSamplesPAL.tech{end}.shortSensorName = 'Pal';

numberOfSamplesPAL.id{end+1} = 8;
numberOfSamplesPAL.name{end+1} = 'total number of PAL samples acquired';
numberOfSamplesPAL.fmt{end+1} = '%d';
numberOfSamplesPAL.tech{end+1} = get_cts5_tech_data_init_struct(275, 'Total number of PAL samples acquired');
numberOfSamplesPAL.tech{end}.shortSensorName = 'Pal';

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
numberOfSamplesTRIDENTE = init_basic_struct;
numberOfSamplesTRIDENTE.pattern = 'TRIDENTE=%u/%u/%u/%u/%u/%u points (%u/%u)';
numberOfSamplesTRIDENTE.count = 8;

numberOfSamplesTRIDENTE.id{end+1} = 1;
numberOfSamplesTRIDENTE.name{end+1} = 'number of TRIDENTE samples during descent to parking depth';
numberOfSamplesTRIDENTE.fmt{end+1} = '%d';
numberOfSamplesTRIDENTE.tech{end+1} = get_cts5_tech_data_init_struct(216, 'Number of TRIDENTE samples during descent to parking depth');
numberOfSamplesTRIDENTE.tech{end}.shortSensorName = 'Tridente';

numberOfSamplesTRIDENTE.id{end+1} = 2;
numberOfSamplesTRIDENTE.name{end+1} = 'number of TRIDENTE samples during drift at parking depth';
numberOfSamplesTRIDENTE.fmt{end+1} = '%d';
numberOfSamplesTRIDENTE.tech{end+1} = get_cts5_tech_data_init_struct(217, 'Number of TRIDENTE samples during drift at parking depth');
numberOfSamplesTRIDENTE.tech{end}.shortSensorName = 'Tridente';

numberOfSamplesTRIDENTE.id{end+1} = 3;
numberOfSamplesTRIDENTE.name{end+1} = 'number of TRIDENTE samples during descent to profile depth';
numberOfSamplesTRIDENTE.fmt{end+1} = '%d';
numberOfSamplesTRIDENTE.tech{end+1} = get_cts5_tech_data_init_struct(218, 'Number of TRIDENTE samples during descent to profile depth');
numberOfSamplesTRIDENTE.tech{end}.shortSensorName = 'Tridente';

numberOfSamplesTRIDENTE.id{end+1} = 4;
numberOfSamplesTRIDENTE.name{end+1} = 'number of TRIDENTE samples during drift at profile depth';
numberOfSamplesTRIDENTE.fmt{end+1} = '%d';
numberOfSamplesTRIDENTE.tech{end+1} = get_cts5_tech_data_init_struct(219, 'Number of TRIDENTE samples during drift at profile depth');
numberOfSamplesTRIDENTE.tech{end}.shortSensorName = 'Tridente';

numberOfSamplesTRIDENTE.id{end+1} = 5;
numberOfSamplesTRIDENTE.name{end+1} = 'number of TRIDENTE samples during ascent to surface';
numberOfSamplesTRIDENTE.fmt{end+1} = '%d';
numberOfSamplesTRIDENTE.tech{end+1} = get_cts5_tech_data_init_struct(220, 'Number of TRIDENTE samples during ascent to surface');
numberOfSamplesTRIDENTE.tech{end}.shortSensorName = 'Tridente';

numberOfSamplesTRIDENTE.id{end+1} = 6;
numberOfSamplesTRIDENTE.name{end+1} = 'number of TRIDENTE surface samples';
numberOfSamplesTRIDENTE.fmt{end+1} = '%d';
numberOfSamplesTRIDENTE.tech{end+1} = get_cts5_tech_data_init_struct(221, 'Number of TRIDENTE surface samples');
numberOfSamplesTRIDENTE.tech{end}.shortSensorName = 'Tridente';

numberOfSamplesTRIDENTE.id{end+1} = 7;
numberOfSamplesTRIDENTE.name{end+1} = 'number of TRIDENTE samples removed by the decimation process';
numberOfSamplesTRIDENTE.fmt{end+1} = '%d';
numberOfSamplesTRIDENTE.tech{end+1} = get_cts5_tech_data_init_struct(274, 'Number of TRIDENTE samples removed by the decimation process');
numberOfSamplesTRIDENTE.tech{end}.shortSensorName = 'Tridente';

numberOfSamplesTRIDENTE.id{end+1} = 8;
numberOfSamplesTRIDENTE.name{end+1} = 'total number of TRIDENTE samples acquired';
numberOfSamplesTRIDENTE.fmt{end+1} = '%d';
numberOfSamplesTRIDENTE.tech{end+1} = get_cts5_tech_data_init_struct(275, 'Total number of TRIDENTE samples acquired');
numberOfSamplesTRIDENTE.tech{end}.shortSensorName = 'Tridente';

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
transmissionQualitySurvey = init_basic_struct;
transmissionQualitySurvey.pattern = 'SQ=%u sec QC=%f/%f/%f';
transmissionQualitySurvey.count = 4;

transmissionQualitySurvey.id{end+1} = 1;
transmissionQualitySurvey.name{end+1} = 'signal quality (sec)';
transmissionQualitySurvey.fmt{end+1} = '%d';
transmissionQualitySurvey.tech{end+1} = get_cts5_tech_data_init_struct(276, 'Signal quality (sec)');

transmissionQualitySurvey.id{end+1} = 2;
transmissionQualitySurvey.name{end+1} = 'flow rate estimated quality #1 (kbyte/minute)';
transmissionQualitySurvey.fmt{end+1} = '%g';
transmissionQualitySurvey.tech{end+1} = get_cts5_tech_data_init_struct(277, 'Flow rate estimated quality #1 (kbyte/minute)');

transmissionQualitySurvey.id{end+1} = 3;
transmissionQualitySurvey.name{end+1} = 'flow rate estimated quality #2 (kbyte/minute)';
transmissionQualitySurvey.fmt{end+1} = '%g';
transmissionQualitySurvey.tech{end+1} = get_cts5_tech_data_init_struct(278, 'Flow rate estimated quality #2 (kbyte/minute)');

transmissionQualitySurvey.id{end+1} = 4;
transmissionQualitySurvey.name{end+1} = 'flow rate estimated quality #3 (kbyte/minute)';
transmissionQualitySurvey.fmt{end+1} = '%g';
transmissionQualitySurvey.tech{end+1} = get_cts5_tech_data_init_struct(279, 'Flow rate estimated quality #3 (kbyte/minute)');
...
o_techInfoStruct.DATA{end+1} = eventFileReceived;
% o_techInfoStruct.DATA{end+1} = payloadFileReceived;
...
o_techInfoStruct.DATA{end+1} = numberOfSamplesPAL;
o_techInfoStruct.DATA{end+1} = numberOfSamplesTRIDENTE;
o_techInfoStruct.DATA{end+1} = transmissionQualitySurvey;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
sensorActivationPAL = init_basic_struct;
sensorActivationPAL.pattern = 'PAL=%u min';
sensorActivationPAL.count = 1;

sensorActivationPAL.id{end+1} = 1;
sensorActivationPAL.name{end+1} = 'cumulated PAL activations duration (min)';
sensorActivationPAL.fmt{end+1} = '%d';
sensorActivationPAL.tech{end+1} = get_cts5_tech_data_init_struct(222, 'Cumulated PAL activations duration (min)');
sensorActivationPAL.tech{end}.shortSensorName = 'Pal';

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
sensorActivationTRIDENTE = init_basic_struct;
sensorActivationTRIDENTE.pattern = 'TRIDENTE=%u min';
sensorActivationTRIDENTE.count = 1;

sensorActivationTRIDENTE.id{end+1} = 1;
sensorActivationTRIDENTE.name{end+1} = 'cumulated TRIDENTE activations duration (min)';
sensorActivationTRIDENTE.fmt{end+1} = '%d';
sensorActivationTRIDENTE.tech{end+1} = get_cts5_tech_data_init_struct(222, 'Cumulated TRIDENTE activations duration (min)');
sensorActivationTRIDENTE.tech{end}.shortSensorName = 'Tridente';
...
o_techInfoStruct.POWER{end+1} = sensorActivationPAL;
o_techInfoStruct.POWER{end+1} = sensorActivationTRIDENTE;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
alarmEventDrivenAbort = init_basic_struct;
alarmEventDrivenAbort.pattern = 'Event (abort)';
alarmEventDrivenAbort.count = 0;

alarmEventDrivenAbort.id{end+1} = 1;
alarmEventDrivenAbort.name{end+1} = 'event (abort) alarm received';
alarmEventDrivenAbort.tech{end+1} = get_cts5_tech_data_init_struct(280, 'Event (abort) alarm received');

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
alarmEventDrivenMission = init_basic_struct;
alarmEventDrivenMission.pattern = 'Event (mission)';
alarmEventDrivenMission.count = 0;

alarmEventDrivenMission.id{end+1} = 1;
alarmEventDrivenMission.name{end+1} = 'event (mission) alarm received';
alarmEventDrivenMission.tech{end+1} = get_cts5_tech_data_init_struct(281, 'Event (mission) alarm received');

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
alarmEventDrivenRain = init_basic_struct;
alarmEventDrivenRain.pattern = 'Event (rain)';
alarmEventDrivenRain.count = 0;

alarmEventDrivenRain.id{end+1} = 1;
alarmEventDrivenRain.name{end+1} = 'event (rain) alarm received';
alarmEventDrivenRain.tech{end+1} = get_cts5_tech_data_init_struct(282, 'Event (rain) alarm received');

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
alarmEventDrivenWind = init_basic_struct;
alarmEventDrivenWind.pattern = 'Event (wind)';
alarmEventDrivenWind.count = 0;

alarmEventDrivenWind.id{end+1} = 1;
alarmEventDrivenWind.name{end+1} = 'event (wind) alarm received';
alarmEventDrivenWind.tech{end+1} = get_cts5_tech_data_init_struct(283, 'Event (wind) alarm received');

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
alarmEventDrivenBackscatter = init_basic_struct;
alarmEventDrivenBackscatter.pattern = 'Event (backscatter)';
alarmEventDrivenBackscatter.count = 0;

alarmEventDrivenBackscatter.id{end+1} = 1;
alarmEventDrivenBackscatter.name{end+1} = 'event (backscatter) alarm received';
alarmEventDrivenBackscatter.tech{end+1} = get_cts5_tech_data_init_struct(284, 'Event (backscatter) alarm received');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
sensorErrorBadValueIMU = init_basic_struct;
sensorErrorBadValueIMU.pattern = 'IMU value (%u)';
sensorErrorBadValueIMU.count = 1;

sensorErrorBadValueIMU.id{end+1} = 1;
sensorErrorBadValueIMU.name{end+1} = 'number of BAD VALUE errors for IMU sensor';
sensorErrorBadValueIMU.fmt{end+1} = '%d';
sensorErrorBadValueIMU.tech{end+1} = get_cts5_tech_data_init_struct(228, 'Number of BAD VALUE errors for IMU sensor');
sensorErrorBadValueIMU.tech{end}.shortSensorName = 'Imu';

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
sensorErrorBadValuePAL = init_basic_struct;
sensorErrorBadValuePAL.pattern = 'PAL value (%u)';
sensorErrorBadValuePAL.count = 1;

sensorErrorBadValuePAL.id{end+1} = 1;
sensorErrorBadValuePAL.name{end+1} = 'number of BAD VALUE errors for PAL sensor';
sensorErrorBadValuePAL.fmt{end+1} = '%d';
sensorErrorBadValuePAL.tech{end+1} = get_cts5_tech_data_init_struct(228, 'Number of BAD VALUE errors for PAL sensor');
sensorErrorBadValuePAL.tech{end}.shortSensorName = 'Pal';

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
sensorErrorBadValueTRIDENTE = init_basic_struct;
sensorErrorBadValueTRIDENTE.pattern = 'TRIDENTE value (%u)';
sensorErrorBadValueTRIDENTE.count = 1;

sensorErrorBadValueTRIDENTE.id{end+1} = 1;
sensorErrorBadValueTRIDENTE.name{end+1} = 'number of BAD VALUE errors for TRIDENTE sensor';
sensorErrorBadValueTRIDENTE.fmt{end+1} = '%d';
sensorErrorBadValueTRIDENTE.tech{end+1} = get_cts5_tech_data_init_struct(228, 'Number of BAD VALUE errors for TRIDENTE sensor');
sensorErrorBadValueTRIDENTE.tech{end}.shortSensorName = 'Tridente';
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
sensorErrorNoReplyIMU = init_basic_struct;
sensorErrorNoReplyIMU.pattern = 'IMU default (%u)';
sensorErrorNoReplyIMU.count = 1;

sensorErrorNoReplyIMU.id{end+1} = 1;
sensorErrorNoReplyIMU.name{end+1} = 'number of NO REPLY errors for IMU sensor';
sensorErrorNoReplyIMU.fmt{end+1} = '%d';
sensorErrorNoReplyIMU.tech{end+1} = get_cts5_tech_data_init_struct(229, 'Number of NO REPLY errors for IMU sensor');
sensorErrorNoReplyIMU.tech{end}.shortSensorName = 'Imu';

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
sensorErrorNoReplyPAL = init_basic_struct;
sensorErrorNoReplyPAL.pattern = 'PAL default (%u)';
sensorErrorNoReplyPAL.count = 1;

sensorErrorNoReplyPAL.id{end+1} = 1;
sensorErrorNoReplyPAL.name{end+1} = 'number of NO REPLY errors for PAL sensor';
sensorErrorNoReplyPAL.fmt{end+1} = '%d';
sensorErrorNoReplyPAL.tech{end+1} = get_cts5_tech_data_init_struct(229, 'Number of NO REPLY errors for PAL sensor');
sensorErrorNoReplyPAL.tech{end}.shortSensorName = 'Pal';

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
sensorErrorNoReplyTRIDENTE = init_basic_struct;
sensorErrorNoReplyTRIDENTE.pattern = 'TRIDENTE default (%u)';
sensorErrorNoReplyTRIDENTE.count = 1;

sensorErrorNoReplyTRIDENTE.id{end+1} = 1;
sensorErrorNoReplyTRIDENTE.name{end+1} = 'number of NO REPLY errors for TRIDENTE sensor';
sensorErrorNoReplyTRIDENTE.fmt{end+1} = '%d';
sensorErrorNoReplyTRIDENTE.tech{end+1} = get_cts5_tech_data_init_struct(229, 'Number of NO REPLY errors for TRIDENTE sensor');
sensorErrorNoReplyTRIDENTE.tech{end}.shortSensorName = 'Tridente';
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
sensorErrorBrokenIMU = init_basic_struct;
sensorErrorBrokenIMU.pattern = 'IMU broken';
sensorErrorBrokenIMU.count = 0;

sensorErrorBrokenIMU.id{end+1} = 1;
sensorErrorBrokenIMU.name{end+1} = 'BROKEN alarm for IMU sensor';
sensorErrorBrokenIMU.tech{end+1} = get_cts5_tech_data_init_struct(230, 'BROKEN alarm for IMU sensor');
sensorErrorBrokenIMU.tech{end}.shortSensorName = 'Imu';

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
sensorErrorBrokenPAL = init_basic_struct;
sensorErrorBrokenPAL.pattern = 'PAL broken';
sensorErrorBrokenPAL.count = 0;

sensorErrorBrokenPAL.id{end+1} = 1;
sensorErrorBrokenPAL.name{end+1} = 'BROKEN alarm for PAL sensor';
sensorErrorBrokenPAL.tech{end+1} = get_cts5_tech_data_init_struct(230, 'BROKEN alarm for PAL sensor');
sensorErrorBrokenPAL.tech{end}.shortSensorName = 'Pal';

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
sensorErrorBrokenTRIDENTE = init_basic_struct;
sensorErrorBrokenTRIDENTE.pattern = 'TRIDENTE broken';
sensorErrorBrokenTRIDENTE.count = 0;

sensorErrorBrokenTRIDENTE.id{end+1} = 1;
sensorErrorBrokenTRIDENTE.name{end+1} = 'BROKEN alarm for TRIDENTE sensor';
sensorErrorBrokenTRIDENTE.tech{end+1} = get_cts5_tech_data_init_struct(230, 'BROKEN alarm for TRIDENTE sensor');
sensorErrorBrokenTRIDENTE.tech{end}.shortSensorName = 'Tridente';
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
sensorErrorDataSizeUvp6Txo = init_basic_struct;
sensorErrorDataSizeUvp6Txo.pattern = 'UVP6-TXO size (%f KB)';
sensorErrorDataSizeUvp6Txo.count = 1;

sensorErrorDataSizeUvp6Txo.id{end+1} = 1;
sensorErrorDataSizeUvp6Txo.name{end+1} = 'DATA SIZE alarm for UVP6-TXO sensor (KB)';
sensorErrorDataSizeUvp6Txo.fmt{end+1} = '%g';
sensorErrorDataSizeUvp6Txo.tech{end+1} = get_cts5_tech_data_init_struct(231, 'DATA SIZE alarm for UVP6-TXO sensor (KB)');
sensorErrorDataSizeUvp6Txo.tech{end}.shortSensorName = 'UvpTxo';
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
sensorErrorDataSizeIMU = init_basic_struct;
sensorErrorDataSizeIMU.pattern = 'IMU size (%f KB)';
sensorErrorDataSizeIMU.count = 1;

sensorErrorDataSizeIMU.id{end+1} = 1;
sensorErrorDataSizeIMU.name{end+1} = 'DATA SIZE alarm for IMU sensor (KB)';
sensorErrorDataSizeIMU.fmt{end+1} = '%g';
sensorErrorDataSizeIMU.tech{end+1} = get_cts5_tech_data_init_struct(231, 'DATA SIZE alarm for IMU sensor (KB)');
sensorErrorDataSizeIMU.tech{end}.shortSensorName = 'Imu';

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
sensorErrorDataSizePAL = init_basic_struct;
sensorErrorDataSizePAL.pattern = 'PAL size (%f KB)';
sensorErrorDataSizePAL.count = 1;

sensorErrorDataSizePAL.id{end+1} = 1;
sensorErrorDataSizePAL.name{end+1} = 'DATA SIZE alarm for PAL sensor (KB)';
sensorErrorDataSizePAL.fmt{end+1} = '%g';
sensorErrorDataSizePAL.tech{end+1} = get_cts5_tech_data_init_struct(231, 'DATA SIZE alarm for PAL sensor (KB)');
sensorErrorDataSizePAL.tech{end}.shortSensorName = 'Pal';

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
sensorErrorDataSizeTRIDENTE = init_basic_struct;
sensorErrorDataSizeTRIDENTE.pattern = 'TRIDENTE size (%f KB)';
sensorErrorDataSizeTRIDENTE.count = 1;

sensorErrorDataSizeTRIDENTE.id{end+1} = 1;
sensorErrorDataSizeTRIDENTE.name{end+1} = 'DATA SIZE alarm for TRIDENTE sensor (KB)';
sensorErrorDataSizeTRIDENTE.fmt{end+1} = '%g';
sensorErrorDataSizeTRIDENTE.tech{end+1} = get_cts5_tech_data_init_struct(231, 'DATA SIZE alarm for TRIDENTE sensor (KB)');
sensorErrorDataSizeTRIDENTE.tech{end}.shortSensorName = 'Tridente';
...
o_techInfoStruct.ALARM{end+1} = alarmEventDrivenAbort;
o_techInfoStruct.ALARM{end+1} = alarmEventDrivenMission;
o_techInfoStruct.ALARM{end+1} = alarmEventDrivenRain;
o_techInfoStruct.ALARM{end+1} = alarmEventDrivenWind;
o_techInfoStruct.ALARM{end+1} = alarmEventDrivenBackscatter;
...
o_techInfoStruct.ALARM{end+1} = sensorErrorBadValueIMU;
o_techInfoStruct.ALARM{end+1} = sensorErrorBadValuePAL;
o_techInfoStruct.ALARM{end+1} = sensorErrorBadValueTRIDENTE;
...
o_techInfoStruct.ALARM{end+1} = sensorErrorNoReplyIMU;
o_techInfoStruct.ALARM{end+1} = sensorErrorNoReplyPAL;
o_techInfoStruct.ALARM{end+1} = sensorErrorNoReplyTRIDENTE;
...
o_techInfoStruct.ALARM{end+1} = sensorErrorBrokenIMU;
o_techInfoStruct.ALARM{end+1} = sensorErrorBrokenPAL;
o_techInfoStruct.ALARM{end+1} = sensorErrorBrokenTRIDENTE;
...
o_techInfoStruct.ALARM{end+1} = sensorErrorDataSizeUvp6Txo;
...
o_techInfoStruct.ALARM{end+1} = sensorErrorDataSizeIMU;
o_techInfoStruct.ALARM{end+1} = sensorErrorDataSizePAL;
o_techInfoStruct.ALARM{end+1} = sensorErrorDataSizeTRIDENTE;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
