...
%
% SYNTAX :
%  print_tech_data_in_csv_file_230(a_tabTech1, a_tabTech2, a_deepCycle)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function print_tech_data_in_csv_file_230(a_tabTech1, a_tabTech2, a_deepCycle)
...
elseif (length(idF2) == 1)
   ...
   if (a_deepCycle == 1)
      ...
      fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #2; "Subsurface" meas TEMP_COUNT_DOXY; %d; => %.3f; degC\n', ...
         g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech2(id, 16+ID_OFFSET), compute_TEMP_DOXY_JAC_230(a_tabTech2(id, 16+ID_OFFSET)));
      fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #2; "Subsurface" meas COUNT_DOXY; %d\n', ...
         g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech2(id, 17+ID_OFFSET));
      fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #2; "Subsurface" meas LED_FLASHING_COUNT_DOXY; %d\n', ...
      ...
      fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #2; Total number of groundings; %d\n', ...
         g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech2(id, 19+ID_OFFSET));
      if (a_tabTech2(id, 19+ID_OFFSET) > 0)
         ...
         fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #2; First grounding minute; %d; => %s\n', ...
            g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech2(id, 22+ID_OFFSET), format_time_dec_argo(a_tabTech2(id, 22+ID_OFFSET)/60));
         if (~isempty(cycleStartDateDay))
            firstGroundingDate = cycleStartDateDay + a_tabTech2(id, 21+ID_OFFSET) + a_tabTech2(id, 22+ID_OFFSET)/1440;
         ...
         fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #2; Nb EV actions to set first grounding; %d\n', ...
            g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech2(id, 24+ID_OFFSET));
      end
      if (a_tabTech2(id, 19+ID_OFFSET) > 1)
         ...
         fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #2; Second grounding minute; %d; => %s\n', ...
            g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech2(id, 27+ID_OFFSET), format_time_dec_argo(a_tabTech2(id, 27+ID_OFFSET)/60));
         if (~isempty(cycleStartDateDay))
            secondGroundingDate = cycleStartDateDay + a_tabTech2(id, 26+ID_OFFSET) + a_tabTech2(id, 27+ID_OFFSET)/1440;
      ...
      fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #2; Internal vacuum (5 mbar resolution) before ascent; %d; => %d mbar\n', ...
         g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech2(id, 37+ID_OFFSET), a_tabTech2(id, 37+ID_OFFSET)*5);
   end
   ...
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #2; Float last reset gregorian day; %d\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech2(id, 41+ID_OFFSET));
   ...
   floatLastResetTime = datenum(sprintf('%02d%02d%02d', a_tabTech2(id, (38:43)+ID_OFFSET)), 'HHMMSSddmmyy') - g_decArgo_janFirst1950InMatlab;
   ...
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #2; Nb of empty ballast detections; %d\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech2(id, 49+ID_OFFSET));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #2; First empty ballast detection pressure; %d; dbar\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech2(id, 50+ID_OFFSET));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #2; First empty ballast detection phase; %d\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech2(id, 51+ID_OFFSET));
