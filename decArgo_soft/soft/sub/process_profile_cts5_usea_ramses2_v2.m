% ------------------------------------------------------------------------------
% Create the RAMSES2 V2 profiles of CTS5-USEA decoded data.
%
% SYNTAX :
%  [o_tabProfiles, o_tabDrift, o_tabDesc2Prof, o_tabDeepDrift, o_tabSurf] = ...
%    process_profile_cts5_usea_ramses2_v2(a_ramses2V2Data, a_timeData, a_gpsData)
%
% INPUT PARAMETERS :
%   a_ramses2V2Data : CTS5-USEA RAMSES2 V2 data
   ...
   if (~isempty(data))
      ...
      switch (treatId)
         case {g_decArgo_cts5Treat_RW, g_decArgo_cts5Treat_DW}
            ...
            paramRadiometerTimestampOffset = get_netcdf_param_attributes('RADIOMETER_UP_RAD_TIMESTAMPOFFSET');
            ...
            profStruct.paramList = [ ...
               ...
               paramRadiometerTimestampOffset ...
      ...
      profStruct.paramNumberWithSubLevels = 9;
      profStruct.paramNumberOfSubLevels = size(data, 2) - 10;

      data(:, 10) = []; % remove "Number of channels"
