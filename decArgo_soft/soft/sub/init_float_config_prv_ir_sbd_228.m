...
% ------------------------------------------------------------------------------
function init_float_config_prv_ir_sbd_228(a_launchDate)
...
configNames2{end+1} = 'CONFIG_PY00';
for id = [1:16 19]
   configNames2{end+1} = sprintf('CONFIG_FR%02d', id);
end
for id = 0:5
      ...
      if (~isempty(idPos))
         if (~isempty(jConfValues{id}))
            ...
            if ((length(value) == 1) && (status == 1))
               ...
               elseif (strncmp(jConfNames{id}, 'CONFIG_FR06', length('CONFIG_FR06')) || ...
                     strncmp(jConfNames{id}, 'CONFIG_FR07', length('CONFIG_FR07')) || ...
                     strncmp(jConfNames{id}, 'CONFIG_FR12', length('CONFIG_FR12')) || ...
                     strncmp(jConfNames{id}, 'CONFIG_FR13', length('CONFIG_FR13')) || ...
                     strncmp(jConfNames{id}, 'CONFIG_FR14', length('CONFIG_FR14')) || ...
                     strncmp(jConfNames{id}, 'CONFIG_FR15', length('CONFIG_FR15')) || ...
                     strncmp(jConfNames{id}, 'CONFIG_FR16', length('CONFIG_FR16')))
                  configValues2(idPos) = value/10;
               else
