...
for idL = 1:size(a_sensorData, 1)
   ...
   elseif (msgNum == 2)
      ...
      % compute CHLA
      surfChla = compute_CHLA_301_1015_1101_1105_1110_1111_1112_1114_1115( ...
         surfFluorescenceChla, ...
      ...
      % compute CHLA
      parkChla = compute_CHLA_301_1015_1101_1105_1110_1111_1112_1114_1115( ...
      ...
      % compute BBP700
      parkBbp700 = compute_BBP700_301_1015_1101_1105_1110_1111_1112_1114_1115( ...
...
if (nbLev > 0)
   ...
   % compute CHLA
   profChla = compute_CHLA_301_1015_1101_1105_1110_1111_1112_1114_1115( ...
      profFluorescenceChla, ...
      g_decArgo_fluorescenceChlaDef, g_decArgo_chloroADef);
   % duplicate CHLA profile as CHLA_FLUORESCENCE one
   ...
   % compute BBP700
   profBbp700 = compute_BBP700_301_1015_1101_1105_1110_1111_1112_1114_1115( ...
      profBetaBackscattering700, ...
      g_decArgo_betaBackscattering700Def, g_decArgo_backscatDef, ...
   ...
   if (~isempty(o_surfData))
      ...
      if (~isempty(idLev))
         ...
         % compute BBP700
         surfBbp700 = compute_BBP700_301_1015_1101_1105_1110_1111_1112_1114_1115( ...
            o_surfData.data(:, 5), ...
            g_decArgo_betaBackscattering700Def, g_decArgo_backscatDef, ...
