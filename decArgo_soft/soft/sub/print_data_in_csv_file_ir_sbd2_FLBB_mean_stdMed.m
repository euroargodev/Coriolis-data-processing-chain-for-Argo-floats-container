...
if (isempty(idDataStdMed))
   ...
   dataMean(:, 6) = compute_CHLA_301_1015_1101_1105_1110_1111_1112_1114_1115(dataMean(:, 4), g_decArgo_chloroADef, paramCHLA.fillValue);
   ...
   if (isempty(idDataMean))
      ...
      paramCHLA = get_netcdf_param_attributes('CHLA');
      data(:, 10) = compute_CHLA_301_1015_1101_1105_1110_1111_1112_1114_1115(data(:, 4), g_decArgo_chloroADef, paramCHLA.fillValue);
