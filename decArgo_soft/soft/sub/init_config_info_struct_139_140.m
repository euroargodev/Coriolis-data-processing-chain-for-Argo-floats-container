...
% ------------------------------------------------------------------------------
% RELEASES :
%   07/16/2024 - RNU - creation
% ------------------------------------------------------------------------------
function [o_configSectionList, o_configInfoStruct] = init_config_info_struct_139_140
...
for idP = 0:30
   ...
   switch (idP)
      ...
      case 25
         param.fmtIn = '%u';
         param.name = 'pressure averaging number during emergence reduction';
         param.fmtOut = '%d';
      case 26
         param.fmtIn = '%s';
         param.name = 'emergence optimization 1';
         param.fmtOut = '%s';
      case 27
         param.fmtIn = '%s';
         param.name = 'emergence optimization 1';
      ...
      case 28
         param.fmtIn = '%f';
         param.name = 'speed controlled braking power in ascent abortion';
         param.fmtOut = '%g';
      case 29
         param.fmtIn = '%f';
         param.name = 'minimum volume of an SV action during descent/repositioning (cm3)';
         param.fmtOut = '%g';
      case 30
         param.fmtIn = '%u';
         param.name = 'pressure monitoring period during park repositioning (s)';
         param.fmtOut = '%d';
   end
   o_configInfoStruct.TECHNICAL{end+1} = param;
end

o_configInfoStruct.EVENT_DRIVEN = [];
for idP = 0:1
   param = init_basic_struct;
   param.num = idP;
   switch (idP)
      case 0
         param.fmtIn = '%s';
         param.name = 'enable/disable event-driven feature';
         param.fmtOut = '%s';
      case 1
         param.fmtIn = '%u';
         param.name = 'event polling period: maximum propagation delay between event detection and immediate ascent (s)';
         param.fmtOut = '%d';
   end
   o_configInfoStruct.EVENT_DRIVEN{end+1} = param;
end

o_configInfoStruct.EVENT_RAIN = [];
for idP = 0:12
   param = init_basic_struct;
   param.num = idP;
   switch (idP)
      case 0
         param.fmtIn = '%s';
         param.name = 'enable/disable rain detection';
         param.fmtOut = '%s';
      case 1
         param.fmtIn = '%f';
         param.name = 'average criteria threshold (mm/h)';
         param.fmtOut = '%g';
      case 2
         param.fmtIn = '%f';
         param.name = 'median criteria threshold (mm/h)';
         param.fmtOut = '%g';
      case 3
         param.fmtIn = '%f';
         param.name = 'cumulative criteria threshold (mm/h)';
         param.fmtOut = '%g';
      case 4
         param.fmtIn = '%f';
         param.name = 'minimum criteria threshold (mm/h)';
         param.fmtOut = '%g';
      case 5
         param.fmtIn = '%f';
         param.name = 'maximum criteria threshold (mm/h)';
         param.fmtOut = '%g';
      case 6
         param.fmtIn = '%f';
         param.name = 'variability criteria threshold (mm/h)';
         param.fmtOut = '%g';
      case 7
         param.fmtIn = '%u';
         param.name = 'strength calculation period (s)';
         param.fmtOut = '%d';
      case 8
         param.fmtIn = '%s';
         param.name = 'criteria combination strategy (hex)';
         param.fmtOut = '%s';
      case 9
         param.fmtIn = '%u';
         param.name = 'event mission duration (number of cycles)';
         param.fmtOut = '%d';
      case 10
         param.fmtIn = '%u';
         param.name = 'rest period (s)';
         param.fmtOut = '%d';
      case 11
         param.fmtIn = '%s';
         param.name = 'activate/deactivate the stand-alone restore mode';
         param.fmtOut = '%s';
      case 12
         param.fmtIn = '%u';
         param.name = 'calm period (s)';
         param.fmtOut = '%d';
   end
   o_configInfoStruct.EVENT_RAIN{end+1} = param;
end

o_configInfoStruct.EVENT_WIND = [];
for idP = 0:12
   param = init_basic_struct;
   param.num = idP;
   switch (idP)
      case 0
         param.fmtIn = '%s';
         param.name = 'enable/disable wind detection';
         param.fmtOut = '%s';
      case 1
         param.fmtIn = '%f';
         param.name = 'average criteria threshold (mm/h)';
   ...
   o_configInfoStruct.EVENT_WIND{end+1} = param;
end
...
for idP = 0:9
   ...
   switch (idP)
      ...
      case 8
         param.fmtIn = '%u';
         param.name = 'iridium registration maximum time before abort (s)';
         param.fmtOut = '%d';
      case 9
         param.fmtIn = '%u';
         param.name = 'skip file threshold';
         param.fmtOut = '%d';
   end
...
for idP = 0:3
   ...
   switch (idP)
      ...
      case 2
         param.fmtIn = '%f';
         param.name = 'electro valve engine efficiency';
         param.fmtOut = '%g';
      case 3
         param.fmtIn = '%f';
         param.name = 'pump valve engine efficiency';
         param.fmtOut = '%g';
   end
...
% PAL
o_configInfoStruct.SENSOR_23 = o_configInfoStruct.SENSOR_;
for idP = 54:68
   param = init_basic_struct;
   param.num = idP;
   switch (idP)
      case 54
         param.fmtIn = '%u';
         param.name = 'average number';
         param.fmtOut = '%d';
      case 55
         param.fmtIn = '%u';
         param.name = 'transmission format';
         param.fmtOut = '%d';
      case 56
         param.fmtIn = '%u';
      ...
      case 57
         param.fmtIn = '%f';
         param.name = 'stationarity detection threshold';
         param.fmtOut = '%g';
      case 58
         param.fmtIn = '%s';
         param.name = 'enable/disable band normalization';
         param.fmtOut = '%s';
      case 60
         param.fmtIn = '%u';
         param.name = 'surface - sampling period / in-air measurements (sec)';
      ...
      case 61
         param.fmtIn = '%f';
         param.name = 'wind estimate – coefficient a3';
         param.fmtOut = '%g';
      case 62
         param.fmtIn = '%f';
         param.name = 'wind estimate – coefficient a2';
         param.fmtOut = '%g';
      case 63
         param.fmtIn = '%f';
         param.name = 'wind estimate – coefficient a1';
         param.fmtOut = '%g';
      case 64
         param.fmtIn = '%f';
         param.name = 'wind estimate – coefficient a0';
         param.fmtOut = '%g';
      case 65
         param.fmtIn = '%f';
         param.name = 'rain estimate – coefficient a3';
         param.fmtOut = '%g';
      case 66
         param.fmtIn = '%f';
         param.name = 'rain estimate – coefficient a2';
         param.fmtOut = '%g';
      case 67
         param.fmtIn = '%f';
         param.name = 'rain estimate – coefficient a1';
         param.fmtOut = '%g';
      case 68
         param.fmtIn = '%f';
         param.name = 'rain estimate – coefficient a0';
         param.fmtOut = '%g';
   end
   o_configInfoStruct.SENSOR_23{end+1} = param;
end

% TRIDENTE
o_configInfoStruct.SENSOR_24 = o_configInfoStruct.SENSOR_;
for idP = 54:60
   param = init_basic_struct;
   param.num = idP;
   switch (idP)
   ...
   o_configInfoStruct.SENSOR_24{end+1} = param;
end
...
o_configInfoStruct.TRIDENTE = [];
param = init_basic_struct;
param.num = 0;
param.fmtIn = '%u';
param.name = 'serial port number';
param.fmtOut = '%d';
o_configInfoStruct.TRIDENTE{end+1} = param;

o_configInfoStruct.PAL = [];
param = init_basic_struct;
param.num = 0;
param.fmtIn = '%u';
param.name = 'serial port number';
param.fmtOut = '%d';
o_configInfoStruct.PAL{end+1} = param;
