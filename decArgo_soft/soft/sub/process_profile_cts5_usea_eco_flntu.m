...
%    process_profile_cts5_usea_eco_flntu(a_ecoData, a_timeData, a_gpsData)
%
% INPUT PARAMETERS :
...
for idP = 1:length(a_ecoData)
   ...
   elseif (phaseId == g_decArgo_cts5PhaseSurface)
      ...
      fprintf('WARNING: Float #%d Cycle #%d: (Cy,Ptn)=(%d,%d): Nothing done yet for processing ECO_FLNTU profiles with phase Id #%d\n', ...
         g_decArgo_floatNum, ...
         g_decArgo_cycleNum, ...
