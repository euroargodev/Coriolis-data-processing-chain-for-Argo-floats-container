...
while (again ~= 0)
   ...
   switch (paramName)
      ...
      case 'BETA_BACKSCATTERING700_SCALED'
         o_attributeStruct = struct('name', 'BETA_BACKSCATTERING700_SCALED', ...
            'longName', 'Factory calibrated total angle specific volume from backscattering sensor at 700 nanometers', ...
            'standardName', '', ...
            'fillValue', single(99999), ...
            'units', 'm-1sr-1', ...
            'validMin', '', ...
      ...
      case 'BETA_BACKSCATTERING700_SCALED_STD'
         o_attributeStruct = struct('name', 'BETA_BACKSCATTERING700_SCALED_STD', ...
            'longName', 'Standard deviation of factory calibrated total angle specific volume from backscattering sensor at 700 nanometers', ...
            'standardName', '', ...
            'fillValue', single(99999), ...
            'units', 'm-1sr-1', ...
            'validMin', '', ...
      ...
      case 'BETA_BACKSCATTERING700_SCALED_MED'
         o_attributeStruct = struct('name', 'BETA_BACKSCATTERING700_SCALED_MED', ...
            'longName', 'Median value of factory calibrated total angle specific volume from backscattering sensor at 700 nanometers', ...
            'standardName', '', ...
            'fillValue', single(99999), ...
            'units', 'm-1sr-1', ...
            'validMin', '', ...
      ...
      case 'LAMP_REFERENCE_1'
         o_attributeStruct = struct('name', 'LAMP_REFERENCE_1', ...
            'longName', 'Reference LED intensity counts lampReference1', ...
            'standardName', '', ...
            'fillValue', int32(99999), ...
            'units', '', ...
            'validMin', '', ...
            'validMax', '', ...
            'axis', '', ...
      ...
      case 'RAW_DOWNWELLING_IRRADIANCE555_STD'
         o_attributeStruct = struct('name', 'RAW_DOWNWELLING_IRRADIANCE555_STD', ...
            'longName', 'Standard deviation of raw downwelling irradiance at 555 nanometers', ...
            'standardName', '', ...
            'fillValue', double(netcdf.getConstant('NC_FILL_DOUBLE')), ...
            'units', 'count', ...
            'validMin', '', ...
      ...
      case 'RAW_DOWNWELLING_IRRADIANCE555_MED'
         o_attributeStruct = struct('name', 'RAW_DOWNWELLING_IRRADIANCE555_MED', ...
            'longName', 'Median value of raw downwelling irradiance at 555 nanometers', ...
            'standardName', '', ...
            'fillValue', double(netcdf.getConstant('NC_FILL_DOUBLE')), ...
            'units', 'count', ...
            'validMin', '', ...
      ...
      case 'PRESSURE_AirBladder_dbar' % for TECH_TIME
         o_attributeStruct = struct('name', 'PRESSURE_AirBladder', ...
            'longName', 'measured in COUNT - approx 148 COUNT', ...
            'standardName', '', ...
            'fillValue', single(99999), ...
            'units', 'dbar', ...
            'validMin', '', ...
      ...
      case 'VOLTAGE_Battery_volts' % for TECH_TIME
         o_attributeStruct = struct('name', 'VOLTAGE_Battery', ...
            'longName', 'battery voltage when battery capacity is unknown', ...
            'standardName', '', ...
            'fillValue', single(99999), ...
            'units', 'volts', ...
            'validMin', '', ...
      ...
      case 'PRESSURE_InternalVacuum_dbar' % for TECH_TIME
         o_attributeStruct = struct('name', 'PRESSURE_InternalVacuum', ...
            'longName', 'units might be (mbar) or (COUNT) or (inHg)', ...
            'standardName', '', ...
            'fillValue', single(99999), ...
            'units', 'dbar', ...
            'validMin', '', ...
      ...
      case 'CURRENT_Battery_mA' % for TECH_AUX_TIME
      ...
      case 'VOLUME_OilVolumeTransferredToAscentWhenGrounded_cm^3' % for TECH_TIME
         o_attributeStruct = struct('name', 'VOLUME_OilVolumeTransferredToAscentWhenGrounded', ...
            'longName', '"Oil volume, transferred to the external bladder, needed to leave the sea bottom when grounded. "', ...
            'standardName', '', ...
            'fillValue', single(99999), ...
            'units', 'cm^3', ...
            'validMin', '', ...
      ...
      case 'TECH_AUX_VOLUME_OilVolumeTransferredToAscentWhenGrounded_cm^3' % for TECH_TIME
         o_attributeStruct = struct('name', 'TECH_AUX_VOLUME_OilVolumeTransferredToAscentWhenGrounded_cm^3', ...
            'longName', 'Oil volume, transferred to the external bladder, needed to leave the sea bottom when grounded. ', ...
            'standardName', '', ...
            'fillValue', single(99999), ...
            'units', 'cm^3', ...
      ...
      case 'TECH_AUX_VOLUME_PumpOilVolumeTransferred_cm^3' % for TECH_AUX_TIME
         o_attributeStruct = struct('name', 'TECH_AUX_VOLUME_PumpOilVolumeTransferred_cm^3', ...
            'longName', 'Oil volume transferred to the external bladder by the pump action.', ...
            'standardName', '', ...
            'fillValue', single(99999), ...
            'units', 'cm^3', ...
            'validMin', '', ...
      ...
      case 'TECH_AUX_VOLUME_ValveOilVolumeTransferred_cm^3' % for TECH_AUX_TIME
         o_attributeStruct = struct('name', 'TECH_AUX_VOLUME_ValveOilVolumeTransferred_cm^3', ...
            'longName', 'Oil volume transferred to the external bladder by the valve action.', ...
            'standardName', '', ...
            'fillValue', single(99999), ...
            'units', 'cm^3', ...
            'validMin', '', ...
      ...
      case 'PSAL_DynamicCorrection' % for PROF_AUX
         o_attributeStruct = struct('name', 'PSAL_DynamicCorrection', ...
            'longName', 'Practical salinity with onboard RBR dynamic correction', ...
            'standardName', '', ...
            'fillValue', single(99999), ...
            'units', 'psu', ...
            'validMin', single(2), ...
      ...
      case 'BLACK_NB_SIZE_SPECTRA_PARTICLES'
         o_attributeStruct = struct('name', 'BLACK_NB_SIZE_SPECTRA_PARTICLES', ...
            'longName', 'Number of particles without light per class of the slice', ...
            'standardName', '', ...
            'fillValue', int32(-1), ...
            'units', 'count', ...
            'validMin', '', ...
      ...
      case 'SPECTRUM_TYPE_NITRATE'
         o_attributeStruct = struct('name', 'SPECTRUM_TYPE_NITRATE', ...
            'longName', 'Type of the recorded intensity spectrum	(5: raw dark, 4: raw light or 2: calibrated)', ...
            'standardName', '', ...
            'fillValue', int32(-1), ...
            'units', 'dimensionless', ...
            'validMin', int32(2), ...
      ...
      case 'DOWN_IRRADIANCE_SPECTRUM'
         o_attributeStruct = struct('name', 'DOWN_IRRADIANCE_SPECTRUM', ...
            'longName', 'Downwelling irradiance spectrum', ...
            'standardName', '', ...
            'fillValue', single(99999), ...
            'units', 'W/m^2/nm', ...
            'validMin', '', ...
      ...
      case 'DOWN_IRRADIANCE_SPECTRUM_WAVELENGTHS'
         o_attributeStruct = struct('name', 'DOWN_IRRADIANCE_SPECTRUM_WAVELENGTHS', ...
            'longName', 'Wavelength associated to downwelling irradiance spectrum', ...
            'standardName', '', ...
            'fillValue', single(99999), ...
            'units', 'nm', ...
            'validMin', '', ...
      ...
      case 'RADIOMETER_DOWN_IRR_TIMESTAMPOFFSET'
         o_attributeStruct = struct('name', 'RADIOMETER_DOWN_IRR_TIMESTAMPOFFSET', ...
            'longName', 'Time elapsed in seconds between the end of the radiometric acquisition and the time stamp of the float', ...
            'standardName', '', ...
            'fillValue', single(99999), ...
            'units', 'sec', ...
            'validMin', single(0), ...
            'validMax', single(63.75), ...
            'axis', '', ...
            'cFormat', '%.2f', ...
            'fortranFormat', 'F.2', ...
      ...
      case 'RADIOMETER_UP_RAD_TIMESTAMPOFFSET'
         o_attributeStruct = struct('name', 'RADIOMETER_UP_RAD_TIMESTAMPOFFSET', ...
            'longName', 'Time elapsed in seconds between the end of the radiometric acquisition and the time stamp of the float', ...
            'standardName', '', ...
            'fillValue', single(99999), ...
            'units', 'sec', ...
      ...
      case 'UP_RADIANCE_SPECTRUM'
         o_attributeStruct = struct('name', 'UP_RADIANCE_SPECTRUM', ...
            'longName', 'Upwelling radiance spectrum', ...
            'standardName', '', ...
            'fillValue', single(99999), ...
            'units', 'W/m^2/nm', ...
            'validMin', '', ...
      ...
      case 'UP_RADIANCE_SPECTRUM_WAVELENGTHS'
         o_attributeStruct = struct('name', 'UP_RADIANCE_SPECTRUM_WAVELENGTHS', ...
            'longName', 'Wavelength associated to upwelling radiance spectrum', ...
            'standardName', '', ...
            'fillValue', single(99999), ...
            'units', 'nm', ...
            'validMin', '', ...
      ...
      otherwise
         ...
         if (again == 1)
            % names like <PARAM>_2
            if ((a_paramName(end-1) == '_') && ~isletter(a_paramName(end)))
               paramName = a_paramName(1:end-2);
            end
            again = 2;
         elseif (again == 2)
            % names like <PARAM>_2_STD or <PARAM>_2_MED
            if ((length(a_paramName) > 4) && ...
                  (strcmp(a_paramName(end-3:end), '_STD') || strcmp(a_paramName(end-3:end), '_MED')))
               if ((a_paramName(end-5) == '_') && ~isletter(a_paramName(end-4)))
                  paramName = a_paramName;
                  paramName(end-4:end-3) = '';
               end
            end
            again = 3;
         else
            ...
            %             %             end
            %
            if (isempty(g_cocs_printErrorMsg) || (g_cocs_printErrorMsg == 1))
