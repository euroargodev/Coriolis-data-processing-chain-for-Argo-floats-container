...
for idVal = 1:length(configValues)
   if (strncmp(a_configDetails{idVal, 2}, 'CONFIG_', length('CONFIG_')) && ~isempty(configValues{idVal}))
      ...
      elseif (strcmp(a_configDetails{idVal, 2}, 'CONFIG_UvpVerticalPressureOffset_dbar'))
         if (str2double(configValues{idVal}) == 999)
            continue
         else
...
o_confAcq = [ ...
   ...
   {'Appendices_ratio'} {'CONFIG_UvpAppendicesRatio'} {'When saving vignettes (Save_images= 2), vignette size to actual object size ratio (default : 1.5)'}; ...
   {'Interval_for_measuring_background_noise'} {'CONFIG_UvpBackgroundNoiseBloc_NUMBER'} {'Background noise measured every ''interval'' (bloc acquired without flashing). Disabled if zero'}; ...
...
o_confTaxo = [ ...
   ...
   {'Taxo_ID_for_class_00'} {'CONFIG_UvpTaxoIdClass00_NUMBER'} {'Ecotaxa taxonomic unique identifier for model''s class 00'}; ...
   {'Taxo_ID_for_class_01'} {'CONFIG_UvpTaxoIdClass01_NUMBER'} {'Ecotaxa taxonomic unique identifier for model''s class 01'}; ...
   {'Taxo_ID_for_class_02'} {'CONFIG_UvpTaxoIdClass02_NUMBER'} {'Ecotaxa taxonomic unique identifier for model''s class 02'}; ...
   {'Taxo_ID_for_class_03'} {'CONFIG_UvpTaxoIdClass03_NUMBER'} {'Ecotaxa taxonomic unique identifier for model''s class 03'}; ...
   {'Taxo_ID_for_class_04'} {'CONFIG_UvpTaxoIdClass04_NUMBER'} {'Ecotaxa taxonomic unique identifier for model''s class 04'}; ...
   {'Taxo_ID_for_class_05'} {'CONFIG_UvpTaxoIdClass05_NUMBER'} {'Ecotaxa taxonomic unique identifier for model''s class 05'}; ...
   {'Taxo_ID_for_class_06'} {'CONFIG_UvpTaxoIdClass06_NUMBER'} {'Ecotaxa taxonomic unique identifier for model''s class 06'}; ...
   {'Taxo_ID_for_class_07'} {'CONFIG_UvpTaxoIdClass07_NUMBER'} {'Ecotaxa taxonomic unique identifier for model''s class 07'}; ...
   {'Taxo_ID_for_class_08'} {'CONFIG_UvpTaxoIdClass08_NUMBER'} {'Ecotaxa taxonomic unique identifier for model''s class 08'}; ...
   {'Taxo_ID_for_class_09'} {'CONFIG_UvpTaxoIdClass09_NUMBER'} {'Ecotaxa taxonomic unique identifier for model''s class 09'}; ...
   {'Taxo_ID_for_class_10'} {'CONFIG_UvpTaxoIdClass10_NUMBER'} {'Ecotaxa taxonomic unique identifier for model''s class 10'}; ...
   {'Taxo_ID_for_class_11'} {'CONFIG_UvpTaxoIdClass11_NUMBER'} {'Ecotaxa taxonomic unique identifier for model''s class 11'}; ...
   {'Taxo_ID_for_class_12'} {'CONFIG_UvpTaxoIdClass12_NUMBER'} {'Ecotaxa taxonomic unique identifier for model''s class 12'}; ...
   {'Taxo_ID_for_class_13'} {'CONFIG_UvpTaxoIdClass13_NUMBER'} {'Ecotaxa taxonomic unique identifier for model''s class 13'}; ...
   {'Taxo_ID_for_class_14'} {'CONFIG_UvpTaxoIdClass14_NUMBER'} {'Ecotaxa taxonomic unique identifier for model''s class 14'}; ...
   {'Taxo_ID_for_class_15'} {'CONFIG_UvpTaxoIdClass15_NUMBER'} {'Ecotaxa taxonomic unique identifier for model''s class 15'}; ...
   {'Taxo_ID_for_class_16'} {'CONFIG_UvpTaxoIdClass16_NUMBER'} {'Ecotaxa taxonomic unique identifier for model''s class 16'}; ...
   {'Taxo_ID_for_class_17'} {'CONFIG_UvpTaxoIdClass17_NUMBER'} {'Ecotaxa taxonomic unique identifier for model''s class 17'}; ...
   {'Taxo_ID_for_class_18'} {'CONFIG_UvpTaxoIdClass18_NUMBER'} {'Ecotaxa taxonomic unique identifier for model''s class 18'}; ...
   {'Taxo_ID_for_class_19'} {'CONFIG_UvpTaxoIdClass19_NUMBER'} {'Ecotaxa taxonomic unique identifier for model''s class 19'}; ...
   {'Taxo_ID_for_class_20'} {'CONFIG_UvpTaxoIdClass20_NUMBER'} {'Ecotaxa taxonomic unique identifier for model''s class 20'}; ...
   {'Taxo_ID_for_class_21'} {'CONFIG_UvpTaxoIdClass21_NUMBER'} {'Ecotaxa taxonomic unique identifier for model''s class 21'}; ...
   {'Taxo_ID_for_class_22'} {'CONFIG_UvpTaxoIdClass22_NUMBER'} {'Ecotaxa taxonomic unique identifier for model''s class 22'}; ...
   {'Taxo_ID_for_class_23'} {'CONFIG_UvpTaxoIdClass23_NUMBER'} {'Ecotaxa taxonomic unique identifier for model''s class 23'}; ...
   {'Taxo_ID_for_class_24'} {'CONFIG_UvpTaxoIdClass24_NUMBER'} {'Ecotaxa taxonomic unique identifier for model''s class 24'}; ...
   {'Taxo_ID_for_class_25'} {'CONFIG_UvpTaxoIdClass25_NUMBER'} {'Ecotaxa taxonomic unique identifier for model''s class 25'}; ...
   {'Taxo_ID_for_class_26'} {'CONFIG_UvpTaxoIdClass26_NUMBER'} {'Ecotaxa taxonomic unique identifier for model''s class 26'}; ...
   {'Taxo_ID_for_class_27'} {'CONFIG_UvpTaxoIdClass27_NUMBER'} {'Ecotaxa taxonomic unique identifier for model''s class 27'}; ...
   {'Taxo_ID_for_class_28'} {'CONFIG_UvpTaxoIdClass28_NUMBER'} {'Ecotaxa taxonomic unique identifier for model''s class 28'}; ...
   {'Taxo_ID_for_class_29'} {'CONFIG_UvpTaxoIdClass29_NUMBER'} {'Ecotaxa taxonomic unique identifier for model''s class 29'}; ...
   {'Taxo_ID_for_class_30'} {'CONFIG_UvpTaxoIdClass30_NUMBER'} {'Ecotaxa taxonomic unique identifier for model''s class 30'}; ...
   {'Taxo_ID_for_class_31'} {'CONFIG_UvpTaxoIdClass31_NUMBER'} {'Ecotaxa taxonomic unique identifier for model''s class 31'}; ...
   {'Taxo_ID_for_class_32'} {'CONFIG_UvpTaxoIdClass32_NUMBER'} {'Ecotaxa taxonomic unique identifier for model''s class 32'}; ...
   {'Taxo_ID_for_class_33'} {'CONFIG_UvpTaxoIdClass33_NUMBER'} {'Ecotaxa taxonomic unique identifier for model''s class 33'}; ...
   {'Taxo_ID_for_class_34'} {'CONFIG_UvpTaxoIdClass34_NUMBER'} {'Ecotaxa taxonomic unique identifier for model''s class 34'}; ...
   {'Taxo_ID_for_class_35'} {'CONFIG_UvpTaxoIdClass35_NUMBER'} {'Ecotaxa taxonomic unique identifier for model''s class 35'}; ...
   {'Taxo_ID_for_class_36'} {'CONFIG_UvpTaxoIdClass36_NUMBER'} {'Ecotaxa taxonomic unique identifier for model''s class 36'}; ...
   {'Taxo_ID_for_class_37'} {'CONFIG_UvpTaxoIdClass37_NUMBER'} {'Ecotaxa taxonomic unique identifier for model''s class 37'}; ...
   {'Taxo_ID_for_class_38'} {'CONFIG_UvpTaxoIdClass38_NUMBER'} {'Ecotaxa taxonomic unique identifier for model''s class 38'}; ...
   {'Taxo_ID_for_class_39'} {'CONFIG_UvpTaxoIdClass39_NUMBER'} {'Ecotaxa taxonomic unique identifier for model''s class 39'}; ...
   ];
...
o_confAcq = [ ...
   ...
   {'Acquisition_frequency'} {'CONFIG_UvpSampleRateMax_hertz'} {'Acquisition frequency (maximum value)'}; ...
   {'Frames_per_bloc'} {'CONFIG_UvpFramesPerBloc_NUMBER'} {'Nb of frames to accumulate and synthesize to send'}; ...
   {'Blocs_per_PT'} {'CONFIG_UvpBlocsPerPt_NUMBER'} {'Nb of blocs to acquire before a new acquisition or asking for a new pressure information'}; ...
   {'Pressure_for_auto_start'} {'CONFIG_UvpPressureAutoStart_dbar'} {'When in CTD mode (PT_mode= 3), pressure value to automatically start the acquisition'}; ...
   {'Pressure_difference_for_auto_stop'} {'CONFIG_UvpPressureAutoStop_dbar'} {'When in CTD mode (PT_mode= 3), pressure drop from deepest value to automatically stop the acquisition'}; ...
   {'Result_sending'} {'CONFIG_UvpResultSending_LOGICAL'} {'0/false: results are never sent - 1/true: synthesized results are sent through RS232 after each bloc'}; ...
   {'Save_synthetic_data_for_delayed_request'} {'CONFIG_UvpSyntheticDataSaving_LOGICAL'} {'0/false: do not save - 1/true: save synthetic data for a potential delayed request (usefull only for troubleshooting)'}; ...
   {'Limit_lpm_detection_size'} {'CONFIG_UvpLpmDetectionLimitESD_um'} {'Minimum size (ESD) to count and analyze objects, utilizes Aa and Exp, (default : 10)'}; ...
   {'Save_images'} {'CONFIG_UvpSavingImages_NUMBER'} {'How to save Images -> 0: don''t save, 1: save whole raw image, 2: save selected vignettes only'}; ...
   {'Vignetting_lower_limit_size'} {'CONFIG_UvpMinVignettingLimitESD_um'} {'When saving vignettes (Save_images= 2), minimum object size (ESD) to save vignette, utilizes Aa and Exp, (default : 645)'}; ...
   {'Appendices_ratio'} {'CONFIG_UvpAppendicesRatio'} {'When saving vignettes (Save_images= 2), vignette size to actual object size ratio (default : 1.5)'}; ...
   {'Interval_for_measuring_background_noise'} {'CONFIG_UvpBackgroundNoiseBloc_NUMBER'} {'Background noise measured every ''interval'' (bloc acquired without flashing). Disabled if zero'}; ...
