...
%
% SYNTAX :
%  [o_opusBlackData] = decode_apmt_opus_black_v2(a_data, a_lastByteNum, a_inputFilePathName)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function [o_opusBlackData] = decode_apmt_opus_black_v2(a_data, a_lastByteNum, a_inputFilePathName)
