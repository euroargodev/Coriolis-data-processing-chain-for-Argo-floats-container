...
% for decId: 105_to_109_111_112_114_115_121_to_126_128_to_133_134
%
% SYNTAX :
%  [o_NITRATE] = compute_drift_NITRATE_from_MOLAR(a_MOLAR_NITRATE, ...
...
% ------------------------------------------------------------------------------
function [o_NITRATE] = compute_drift_NITRATE_from_MOLAR(a_MOLAR_NITRATE, ...
   a_MOLAR_NITRATE_fill_value, a_NITRATE_fill_value, ...
   a_MOLAR_NITRATE_dates, a_ctdDates, a_ctdData, ...compute_drift_NITRATE_from_MOLAR
   a_PRES_fill_value, a_TEMP_fill_value, a_PSAL_fill_value, a_profSuna)
