...
%
% SYNTAX :
%  [o_tabTrajNMeas, o_tabTrajNCycle, o_tabTechNMeas] = process_trajectory_data_230( ...
...
% ------------------------------------------------------------------------------
function [o_tabTrajNMeas, o_tabTrajNCycle, o_tabTechNMeas] = process_trajectory_data_230( ...
   a_cycleNum, a_deepCycle, ...
   a_gpsData, a_iridiumMailData, ...
   a_cycleTimeData, ...
   a_tabTech1, a_tabTech2, ...
...
if (~isempty(a_inAirDate))
   ...
   paramTempCountDoxy = get_netcdf_param_attributes('TEMP_COUNT_DOXY');
   paramCountDoxy = get_netcdf_param_attributes('COUNT_DOXY');
   paramLedFlashingCountDoxy = get_netcdf_param_attributes('LED_FLASHING_COUNT_DOXY');
   paramTempDoxy2 = get_netcdf_param_attributes('TEMP_DOXY_2');
   paramPpoxDoxy2 = get_netcdf_param_attributes('PPOX_DOXY_2');
   ...
   a_inAirTempCountDoxy(find(a_inAirTempCountDoxy == g_decArgo_tempDoxyCountsDef)) = paramTempCountDoxy.fillValue;
   a_inAirCountDoxy(find(a_inAirCountDoxy == g_decArgo_doxyCountsDef)) = paramCountDoxy.fillValue;
   a_inAirLedFlashingCountDoxy(find(a_inAirLedFlashingCountDoxy == g_decArgo_ledFlashingDoxyCountsDef)) = paramLedFlashingCountDoxy.fillValue;
   a_inAirTempDoxy2(find(a_inAirTempDoxy2 == g_decArgo_tempDoxyDef)) = paramTempDoxy2.fillValue;
   a_inAirPpoxDoxy2(find(a_inAirPpoxDoxy2 == g_decArgo_doxyDef)) = paramPpoxDoxy2.fillValue;
   ...
   for idMeas = 1:length(a_inAirPres)
      ...
      measStruct.paramList = [paramPres paramTemp paramSal ...
         paramC1PhaseDoxy paramC2PhaseDoxy paramTempDoxy paramPpoxDoxy ...
         paramTempCountDoxy paramCountDoxy paramLedFlashingCountDoxy paramTempDoxy2 paramPpoxDoxy2];
      ...
      measStruct.paramData = [a_inAirPres(idMeas) a_inAirTemp(idMeas) a_inAirSal(idMeas) ...
         ...
         a_inAirTempCountDoxy(idMeas) a_inAirCountDoxy(idMeas) a_inAirLedFlashingCountDoxy(idMeas) a_inAirTempDoxy2(idMeas) a_inAirPpoxDoxy2(idMeas)];
...
if (a_deepCycle == 1)
   ...
   if (~isempty(a_parkPres))
      ...
      paramLedFlashingCountDoxy = get_netcdf_param_attributes('LED_FLASHING_COUNT_DOXY');
      paramTempDoxy2 = get_netcdf_param_attributes('TEMP_DOXY_2');
      paramDoxy2 = get_netcdf_param_attributes('DOXY_2');
      ...
      a_parkTempCountDoxy(find(a_parkTempCountDoxy == g_decArgo_tempDoxyCountsDef)) = paramTempCountDoxy.fillValue;
      a_parkCountDoxy(find(a_parkCountDoxy == g_decArgo_doxyCountsDef)) = paramCountDoxy.fillValue;
      a_parkLedFlashingCountDoxy(find(a_parkLedFlashingCountDoxy == g_decArgo_ledFlashingDoxyCountsDef)) = paramLedFlashingCountDoxy.fillValue;
      a_parkTempDoxy2(find(a_parkTempDoxy2 == g_decArgo_tempDoxyDef)) = paramTempDoxy2.fillValue;
      a_parkDoxy2(find(a_parkDoxy2 == g_decArgo_doxyDef)) = paramDoxy2.fillValue;
      ...
      for idMeas = 1:length(a_parkPres)
         ...
         % add parameter variables to the structure
         measStruct.paramList = [paramPres paramTemp paramSal ...
            paramC1PhaseDoxy paramC2PhaseDoxy paramTempDoxy paramDoxy ...
            paramTempCountDoxy paramCountDoxy paramLedFlashingCountDoxy paramTempDoxy2 paramDoxy2];
         ...
         measStruct.paramData = [a_parkPres(idMeas) a_parkTemp(idMeas) a_parkSal(idMeas) ...
            ...
            a_parkTempCountDoxy(idMeas) a_parkCountDoxy(idMeas) a_parkLedFlashingCountDoxy(idMeas) a_parkTempDoxy2(idMeas) a_parkDoxy2(idMeas)];
      ...
      idForMean = find(~((a_parkPres == paramPres.fillValue) | ...
         ...
         (a_parkTempCountDoxy == paramTempCountDoxy.fillValue) | ...
         (a_parkCountDoxy == paramCountDoxy.fillValue) | ...
         (a_parkLedFlashingCountDoxy == paramLedFlashingCountDoxy.fillValue) | ...
         (a_parkTempDoxy2 == paramTempDoxy2.fillValue) | ...
         (a_parkDoxy2 == paramDoxy2.fillValue)));
      if (~isempty(idForMean))
         ...
         measStruct.paramData = [mean(a_parkPres(idForMean)) ...
            ...
            mean(a_parkTempCountDoxy(idForMean)) mean(a_parkCountDoxy(idForMean)) ...
            mean(a_parkLedFlashingCountDoxy(idForMean)) mean(a_parkTempDoxy2(idForMean)) ...
            mean(a_parkDoxy2(idForMean))];
         trajNMeasStruct.tabMeas = [trajNMeasStruct.tabMeas; measStruct];
   ...
   if (~isempty(a_nearSurfDate))
      ...
      a_nearSurfTempCountDoxy(find(a_nearSurfTempCountDoxy == g_decArgo_tempDoxyCountsDef)) = paramTempCountDoxy.fillValue;
      a_nearSurfCountDoxy(find(a_nearSurfCountDoxy == g_decArgo_doxyCountsDef)) = paramCountDoxy.fillValue;
      a_nearSurfLedFlashingCountDoxy(find(a_nearSurfLedFlashingCountDoxy == g_decArgo_ledFlashingDoxyCountsDef)) = paramLedFlashingCountDoxy.fillValue;
      a_nearSurfTempDoxy2(find(a_nearSurfTempDoxy2 == g_decArgo_tempDoxyDef)) = paramTempDoxy2.fillValue;
      a_nearSurfPpoxDoxy2(find(a_nearSurfPpoxDoxy2 == g_decArgo_doxyDef)) = paramPpoxDoxy2.fillValue;
      ...
      for idMeas = 1:length(a_nearSurfPres)
         ...
         measStruct.paramData = [a_nearSurfPres(idMeas) a_nearSurfTemp(idMeas) a_nearSurfSal(idMeas) ...
            ...
            a_nearSurfTempCountDoxy(idMeas) a_nearSurfCountDoxy(idMeas) a_nearSurfLedFlashingCountDoxy(idMeas) a_nearSurfTempDoxy2(idMeas) a_nearSurfPpoxDoxy2(idMeas)];
   ...
   if (~isempty(tabTech2) && (a_cycleTimeData.iceAscentAbortedFlag == 0))
      ...
      if (any([pres temp psal] ~= 0))
         ...
         tempCountDoxy = tabTech2(17);
         countDoxy = tabTech2(18);
         ledFlashingCountDoxy = tabTech2(19);
         tempDoxy2 = compute_TEMP_DOXY_JAC_230(tempCountDoxy);
         doxy2 = compute_DOXY_JAC_230(countDoxy, ledFlashingCountDoxy, pres, temp, psal);

         measStruct.paramData = [pres temp psal ...
            c1PhaseDoxy c2PhaseDoxy tempDoxy doxy ...
            tempCountDoxy countDoxy ledFlashingCountDoxy tempDoxy2 doxy2];
