...
%   a_parkDate3T      : 3T park measurement dates
%   a_descProfDate3T  : 3T descending profile measurement dates
%   a_ascProfDate3T   : 3T ascending profile measurement dates
...
%   o_parkDate3TAdj     : 3T park measurement adjusted dates
%   o_descProf3TDateAdj : 3T descending profile measurement adjusted dates
%   o_ascProfDate3TAdj  : 3T ascending profile measurement adjusted dates
...
o_parkDate3TAdj = a_parkDate3T;
o_descProfDate3TAdj = a_descProfDate3T;
o_ascProfDate3TAdj = a_ascProfDate3T;
...
if (~isempty(cycleClockOffset))
   ...
   o_parkDate3TAdj = adjust_meas(a_parkDate3T, cycleClockOffset);
   o_descProfDate3TAdj = adjust_meas(a_descProfDate3T, cycleClockOffset);
   o_ascProfDate3TAdj = adjust_meas(a_ascProfDate3T, cycleClockOffset);
