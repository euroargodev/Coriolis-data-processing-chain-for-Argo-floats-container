...
if (~isempty(a_msgFileList))
   [o_miscInfoMsg, o_configInfoMsg, o_techInfo, o_techData, ...
      ...
      o_gpsDataMsg, o_gpsInfoMsg, iceDetectionMsg, ...
      o_presOffsetData] = ...
...
if (~isempty(a_logFileList))
   [o_miscInfoLog, o_configInfoLog, ...
      o_surfDataLog, ...
      o_gpsDataLog, o_gpsInfoLog, ...
      o_pMarkDataLog, o_timeDataLog, iceDetectionLog, ...
      sbe63ParseIssueDataLog, ...
      o_presOffsetData, o_techData] = ...
      decode_log_apx_ir(a_logFileList, o_presOffsetData, o_techData, a_decoderId);
end

if (~isempty(iceDetectionLog) && (iceDetectionLog.notEmptyFlag == 1))
   o_iceDetection = iceDetectionLog;
else
   o_iceDetection = iceDetectionMsg;
end
