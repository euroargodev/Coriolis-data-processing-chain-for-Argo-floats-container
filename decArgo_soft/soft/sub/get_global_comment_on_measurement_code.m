...
switch (a_decoderId)
   ...
   case {215, 216, 218, 221, 228, 229, 230}
   ...
   case {210, 211, 212, 222, 213, 214, 217, 223, 225, 231, 232}
   ...
   case {122, 123, 124, 125, 126, 127, 128, 129, 130, 131, 132, 133, 134, 135, 136, 137, 138, 139, 140, 141}
      % Provor CTS5
      o_mcList = [ ...
         g_MC_Launch ...
         g_MC_CycleStart ...
   ...
   case {1101, 1105, 1110, 1111, 1112, 1114, 1115}
...
if (~ismember(a_decoderId, g_decArgo_decoderIdListApexApf11Iridium))
   ...
   switch (a_measurementCode)
      ...
      case {g_MC_IceAscentAbort}
         o_comment = 'Ice ascent abort time and pressure';
