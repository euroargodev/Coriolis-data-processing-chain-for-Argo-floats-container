...
% ------------------------------------------------------------------------------
function store_misc_tech_data_for_nc_212_214_216_to_218_222_to_232(a_decodedDataTab, a_decoderId)
...
if (~ismember(a_decoderId, [216])) % ICE mode activation information is not available for Arvor Deep (IFREMER version)
   iceActivatedFlag = 0;
