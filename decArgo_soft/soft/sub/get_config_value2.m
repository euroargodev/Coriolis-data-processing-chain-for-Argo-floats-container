...
%
% SYNTAX :
%  [o_configValue] = get_config_value2(a_configName, a_configNames, a_configValues)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function [o_configValue] = get_config_value2(a_configName, a_configNames, a_configValues)
