...
data(:, 7) = compute_CHLA_1xx_and_1121_to_1132_1322_1323(data(:, 4), g_decArgo_chloroADef, paramCHLA.fillValue);
% paramBBP700 = get_netcdf_param_attributes('BBP700');
% data(:, 8) = compute_BBP700_others_dec_id(data(:, 5), g_decArgo_backscatDef, paramBBP700.fillValue);
paramCDOM = get_netcdf_param_attributes('CDOM');
data(:, 8) = compute_CDOM(data(:, 6), g_decArgo_cdomDef, paramCDOM.fillValue);
