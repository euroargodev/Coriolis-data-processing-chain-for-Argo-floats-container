   ...
   switch (evtNum)
      ...
      case 9000
         if (~isempty(g_decArgo_outputCsvFileId))
            ...
            tabEvt = [tabEvt evt];
            if (data ~= missionNum)
               fprintf('ERROR: Float #%d: Inconsistent mission number (%d while %d is expected) in TECH file: %s\n', ...
                  g_decArgo_floatNum, ...
            ...
            tabEvt = [tabEvt evt];
            if (data ~= cycleNum)
               fprintf('ERROR: Float #%d: Inconsistent cycle number (%d while %d is expected) in TECH file: %s\n', ...
                  g_decArgo_floatNum, ...
