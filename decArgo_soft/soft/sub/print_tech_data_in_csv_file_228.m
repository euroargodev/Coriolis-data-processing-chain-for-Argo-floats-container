...
%
% SYNTAX :
%  print_tech_data_in_csv_file_228(a_tabTech1, a_tabTech2, a_deepCycle)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function print_tech_data_in_csv_file_228(a_tabTech1, a_tabTech2, a_tabTech3, a_deepCycle)
...
if (isempty(a_tabTech1) && isempty(a_tabTech2) && isempty(a_tabTech3))
   return
end
...
elseif (~isempty(idF2))
   ...
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #2; "Subsurface" meas PRES; %d; => %.1f; dbar\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech2(id, 10+ID_OFFSET), sensor_2_value_for_pressure_201_203_215_216_218_221_228_229_230(a_tabTech2(id, 10+ID_OFFSET)));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #2; "Subsurface" meas TEMP; %d; => %.3f; degC\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech2(id, 11+ID_OFFSET), sensor_2_value_for_temp_2xx_1_to_3_15_16_18_21_28_29_30(a_tabTech2(id, 11+ID_OFFSET)));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #2; "Subsurface" meas PSAL; %d; => %.3f; PSU\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech2(id, 12+ID_OFFSET), sensor_2_value_for_salinity_2xx_1_to_3_15_16_18_21_28_29_30(a_tabTech2(id, 12+ID_OFFSET)));
   ...
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #2; Ice detection flag (1: ISA, 2: Sat mask (during previous cycle), 3: ISA & Sat mask (during previous cycle), 4: Ascent hanging); %d\n', ...
...
if (length(idF3) > 1)
   fprintf('ERROR: Float #%d cycle #%d: BUFFER anomaly (%d tech message #3 in the buffer)\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, ...
      length(idF3));
elseif (~isempty(idF3))
   id = idF3(1);

   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; THIRD TECHNICAL PACKET CONTENTS\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum);

   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; Transmission time of technical packet; %s\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, julian_2_gregorian_dec_argo(a_tabTech3(id, end)));

   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; TECH: GENERAL INFORMATION\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum);
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; Cycle number; %d\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech3(id, 1+ID_OFFSET));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; WAPITI card status; %d\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech3(id, 2+ID_OFFSET));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; SBE61 sensor status (end of profile) (0: NOK, 1: Ok); %d\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech3(id, 3+ID_OFFSET));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; SBE61 sensor voltage (dV); %d\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech3(id, 4+ID_OFFSET));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; RBR sensor status (end of profile) (0: NOK, 1: Ok); %d\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech3(id, 5+ID_OFFSET));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; RBR sensor voltage (dV); %d\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech3(id, 6+ID_OFFSET));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; Nb CTD 3T packets for descent; %d\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech3(id, 7+ID_OFFSET));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; Nb CTD 3T packets for drift; %d\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech3(id, 8+ID_OFFSET));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; Nb CTD 3T packets for ascent; %d\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech3(id, 9+ID_OFFSET));

   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; TECH: SBE41 INFORMATION\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum);

   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; SBE41 - Nb meas in zone 1 for descent; %d\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech3(id, 10+ID_OFFSET));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; SBE41 - Nb meas in zone 2 for descent; %d\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech3(id, 11+ID_OFFSET));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; SBE41 - Nb meas in zone 3 for descent; %d\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech3(id, 12+ID_OFFSET));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; SBE41 - Nb meas in zone 4 for descent; %d\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech3(id, 13+ID_OFFSET));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; SBE41 - Nb meas in zone 5 for descent; %d\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech3(id, 14+ID_OFFSET));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; SBE41 - Nb meas during drift park phase; %d\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech3(id, 15+ID_OFFSET));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; SBE41 - Nb meas in zone 1 for ascent; %d\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech3(id, 16+ID_OFFSET));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; SBE41 - Nb meas in zone 2 for ascent; %d\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech3(id, 17+ID_OFFSET));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; SBE41 - Nb meas in zone 3 for ascent; %d\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech3(id, 18+ID_OFFSET));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; SBE41 - Nb meas in zone 4 for ascent; %d\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech3(id, 19+ID_OFFSET));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; SBE41 - Nb meas in zone 5 for ascent; %d\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech3(id, 20+ID_OFFSET));

   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; TECH: SBE61 INFORMATION\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum);

   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; SBE61 - Nb meas in zone 1 for descent; %d\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech3(id, 21+ID_OFFSET));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; SBE61 - Nb meas in zone 2 for descent; %d\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech3(id, 22+ID_OFFSET));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; SBE61 - Nb meas in zone 3 for descent; %d\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech3(id, 23+ID_OFFSET));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; SBE61 - Nb meas in zone 4 for descent; %d\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech3(id, 24+ID_OFFSET));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; SBE61 - Nb meas in zone 5 for descent; %d\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech3(id, 25+ID_OFFSET));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; SBE61 - Nb meas during drift park phase; %d\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech3(id, 26+ID_OFFSET));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; SBE61 - Nb meas in zone 1 for ascent; %d\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech3(id, 27+ID_OFFSET));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; SBE61 - Nb meas in zone 2 for ascent; %d\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech3(id, 28+ID_OFFSET));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; SBE61 - Nb meas in zone 3 for ascent; %d\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech3(id, 29+ID_OFFSET));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; SBE61 - Nb meas in zone 4 for ascent; %d\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech3(id, 30+ID_OFFSET));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; SBE61 - Nb meas in zone 5 for ascent; %d\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech3(id, 31+ID_OFFSET));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; SBE61 - Pressure offset; %d; => %.1f; dbar\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech3(id, 32+ID_OFFSET), sensor_2_value_for_pressure_3T_228_2T_229(a_tabTech3(id, 32+ID_OFFSET)));

   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; TECH: RBR INFORMATION\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum);

   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; RBR - Nb meas in zone 1 for descent; %d\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech3(id, 33+ID_OFFSET));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; RBR - Nb meas in zone 2 for descent; %d\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech3(id, 34+ID_OFFSET));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; RBR - Nb meas in zone 3 for descent; %d\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech3(id, 35+ID_OFFSET));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; RBR - Nb meas in zone 4 for descent; %d\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech3(id, 36+ID_OFFSET));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; RBR - Nb meas in zone 5 for descent; %d\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech3(id, 37+ID_OFFSET));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; RBR - Nb meas during drift park phase; %d\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech3(id, 38+ID_OFFSET));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; RBR - Nb meas in zone 1 for ascent; %d\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech3(id, 39+ID_OFFSET));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; RBR - Nb meas in zone 2 for ascent; %d\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech3(id, 40+ID_OFFSET));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; RBR - Nb meas in zone 3 for ascent; %d\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech3(id, 41+ID_OFFSET));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; RBR - Nb meas in zone 4 for ascent; %d\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech3(id, 42+ID_OFFSET));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; RBR - Nb meas in zone 5 for ascent; %d\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech3(id, 43+ID_OFFSET));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; RBR - Pressure offset; %d; => %.1f; dbar\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech3(id, 44+ID_OFFSET), sensor_2_value_for_pressure_3T_228_2T_229(a_tabTech3(id, 44+ID_OFFSET)));

   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; TECH: LAST PUMPED ASCENT RAW MEAS\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum);

   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; SBE61 - PRES; %d; => %.1f; dbar\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech3(id, 45+ID_OFFSET), sensor_2_value_for_pressure_3T_228_2T_229(a_tabTech3(id, 45+ID_OFFSET)));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; SBE61 - TEMP; %d; => %.3f; degC\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech3(id, 46+ID_OFFSET), sensor_2_value_for_temperature_3T_228_2T_229(a_tabTech3(id, 46+ID_OFFSET)));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; SBE61 - PSAL; %d; => %.3f; PSU\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech3(id, 47+ID_OFFSET), sensor_2_value_for_salinity_3T_228_2T_229(a_tabTech3(id, 47+ID_OFFSET)));

   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; RBR - PRES; %d; => %.1f; dbar\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech3(id, 48+ID_OFFSET), sensor_2_value_for_pressure_3T_228_2T_229(a_tabTech3(id, 48+ID_OFFSET)));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; RBR - TEMP; %d; => %.3f; degC\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech3(id, 49+ID_OFFSET), sensor_2_value_for_temperature_3T_228_2T_229(a_tabTech3(id, 49+ID_OFFSET)));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; RBR - PSAL; %d; => %.3f; PSU\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech3(id, 50+ID_OFFSET), sensor_2_value_for_salinity_3T_228_2T_229(a_tabTech3(id, 50+ID_OFFSET)));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; RBR - TEMP_CNDC; %d; => %.3f; degC\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech3(id, 51+ID_OFFSET), sensor_2_value_for_temp_cndc_3T_228_2T_229(a_tabTech3(id, 51+ID_OFFSET)));

   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #3; Number of acq synchronisations during ascending profile; %d\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech3(id, 52+ID_OFFSET));
