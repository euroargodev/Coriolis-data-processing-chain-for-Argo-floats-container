% ------------------------------------------------------------------------------
% Create the RAMSES V2 profiles of CTS5-USEA decoded data.
%
% SYNTAX :
%  [o_tabProfiles, o_tabDrift, o_tabDesc2Prof, o_tabDeepDrift, o_tabSurf] = ...
%    process_profile_cts5_usea_ramses_v2(a_ramsesV2Data, a_timeData, a_gpsData)
%
% INPUT PARAMETERS :
%   a_ramsesV2Data : CTS5-USEA RAMSES V2 data
   ...
   if (~isempty(data))
      ...
      switch (treatId)
         case {g_decArgo_cts5Treat_RW, g_decArgo_cts5Treat_DW}
            ...
            paramRadiometerTimestampOffset = get_netcdf_param_attributes('RADIOMETER_DOWN_IRR_TIMESTAMPOFFSET');
