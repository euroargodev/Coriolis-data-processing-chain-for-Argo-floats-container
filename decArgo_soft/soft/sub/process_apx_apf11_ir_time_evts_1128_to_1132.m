...
%
% SYNTAX :
%  [o_cycleTimeData] = process_apx_apf11_ir_time_evts_1128_to_1132(a_events, a_cycleTimeData)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function [o_cycleTimeData] = process_apx_apf11_ir_time_evts_1128_to_1132(a_events, a_cycleTimeData)
