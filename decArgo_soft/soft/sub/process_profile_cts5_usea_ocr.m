...
%    process_profile_cts5_usea_ocr(a_ocrData, a_timeData, a_gpsData, a_decoderId)
%
% INPUT PARAMETERS :
...
switch (a_decoderId)
   case {126, 127, 128, 129, 131, 132, 135, 136, 137, 141}
      [o_tabProfiles, o_tabDrift, o_tabDesc2Prof, o_tabDeepDrift, o_tabSurf] = ...
         process_profile_cts5_ocr_126_to_129_131_132_135_to_137_141(a_ocrData, a_timeData, a_gpsData);
   case {130}
      [o_tabProfiles, o_tabDrift, o_tabDesc2Prof, o_tabDeepDrift, o_tabSurf] = ...
         process_profile_cts5_usea_ocr_130(a_ocrData, a_timeData, a_gpsData);
   case {133, 138, 139, 140}
      [o_tabProfiles, o_tabDrift, o_tabDesc2Prof, o_tabDeepDrift, o_tabSurf] = ...
         process_profile_cts5_usea_ocr_133_138_to_140(a_ocrData, a_timeData, a_gpsData);
   case {134}
      [o_tabProfiles, o_tabDrift, o_tabDesc2Prof, o_tabDeepDrift, o_tabSurf] = ...
