...
%
% SYNTAX :
%  [o_CHLA] = compute_CHLA_1xx_and_1121_to_1132_1322_1323(a_FLUORESCENCE_CHLA, ...
...
% ------------------------------------------------------------------------------
function [o_CHLA] = compute_CHLA_1xx_and_1121_to_1132_1322_1323(a_FLUORESCENCE_CHLA, ...
   a_FLUORESCENCE_CHLA_fill_value, a_CHLA_fill_value)
...
elseif (ismember('ECO_FLNTU', g_decArgo_sensorMountedOnFloat))
   ...
   elseif (~isfield(g_decArgo_calibInfo, 'ECO_FLNTU'))
      fprintf('WARNING: Float #%d Cycle #%d: ECO_FLNTU sensor calibration information is missing\n', ...
         ...
         g_decArgo_cycleNum);
      return
   elseif ((isfield(g_decArgo_calibInfo.ECO_FLNTU, 'ScaleFactChloroA')) && ...
