...
%
% SYNTAX :
%  [o_decodedData] = decode_prv_data_ir_sbd_232( ...
...
% ------------------------------------------------------------------------------
function [o_decodedData] = decode_prv_data_ir_sbd_232( ...
   a_tabData, a_sbdFileName, a_sbdFileDate, a_launchDate, a_decoderId)
...
switch (packType)
   ...
   case 5
      ...
      tabNbBits = [ ...
         ...
         16 repmat(8, 1, 5) 16 repmat(8, 1, 5) 16 8 16 repmat(8, 1, 12) 16 16 8 ...
         repmat(8, 1, 5) ...
         ];
      % get item bits
