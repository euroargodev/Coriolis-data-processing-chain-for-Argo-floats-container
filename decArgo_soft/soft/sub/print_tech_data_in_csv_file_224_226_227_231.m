...
%
% SYNTAX :
%  print_tech_data_in_csv_file_224_226_227_231(a_tabTech1, a_tabTech2, a_deepCycle)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function print_tech_data_in_csv_file_224_226_227_231(a_tabTech1, a_tabTech2, a_deepCycle)
...
elseif (length(idF1) == 1)
   ...
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #1_%d; GPS session timeout; %d; times\n', ...
...
elseif (length(idF2) == 1)
   ...
   if (a_deepCycle == 1)
      ...
      fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #2_%d; Nb meas during "near surface" phase; %d\n', ...
         g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech2(id, 2+ID_OFFSET), a_tabTech2(id, 13+ID_OFFSET));
      fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #2_%d; Nb meas during "in air" phase; %d\n', ...
      ...
      fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #2_%d; "Subsurface" meas PRES; %d; => %.1f; dbar\n', ...
         g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech2(id, 2+ID_OFFSET), a_tabTech2(id, 15+ID_OFFSET), sensor_2_value_for_pressure_2xx_2_10_to_14_17_22_to_27_31_32(a_tabTech2(id, 15+ID_OFFSET)));
      fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #2_%d; "Subsurface" meas TEMP; %d; => %.3f; degC\n', ...
         g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech2(id, 2+ID_OFFSET), a_tabTech2(id, 16+ID_OFFSET), sensor_2_value_for_temp_2xx_4_to_14_17_19_20_22_to_27_31_32(a_tabTech2(id, 16+ID_OFFSET)));
      fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #2_%d; "Subsurface" meas PSAL; %d; => %.3f; PSU\n', ...
         g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech2(id, 2+ID_OFFSET), a_tabTech2(id, 17+ID_OFFSET), sensor_2_value_for_salinity_2xx_10_to_14_17_20_22_to_27_31_32(a_tabTech2(id, 17+ID_OFFSET)));
   ...
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #2_%d; Ice detection flag (1: ISA, 2: Sat mask (during previous cycle), 3: ISA & Sat mask (during previous cycle), 4: Ascent hanging); %d\n', ...
   ...
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #2_%d; min "in air" PSAL meas; %d; => %.3f; PSU\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech2(id, 2+ID_OFFSET), a_tabTech2(id, 63+ID_OFFSET), sensor_2_value_for_salinity_2xx_10_to_14_17_20_22_to_27_31_32(a_tabTech2(id, 63+ID_OFFSET)));
end
