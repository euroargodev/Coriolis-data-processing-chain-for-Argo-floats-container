...
%
% SYNTAX :
%  print_float_prog_param_in_csv_file_232(a_floatParam1, a_floatParam2)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function print_float_prog_param_in_csv_file_232(a_floatParam1, a_floatParam2)
...
elseif (size(a_floatParam1, 1) == 1)
   ...
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Prog1_%d; TC29: ''End of life'' management on botton; %d\n', ...
